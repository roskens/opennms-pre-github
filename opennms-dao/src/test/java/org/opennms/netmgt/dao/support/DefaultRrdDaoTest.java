...
public class DefaultRrdDaoTest extends TestCase {
    ...
    public void testFetchLastValue() throws Exception {
        ...
        String directory = m_dao.getRrdBaseDirectory().getAbsolutePath() + File.separator + rrdDir;
        expect(m_rrdStrategy.fetchLastValue(directory, rrdFile, attribute.getName(), interval)).andReturn(expectedValue);
    ...
    public void testFetchLastValueInRange() throws Exception {
        ...
        String directory = m_dao.getRrdBaseDirectory().getAbsolutePath() + File.separator + rrdDir;
        expect(m_rrdStrategy.fetchLastValueInRange(directory, rrdFile, attribute.getName(), interval, range)).andReturn(expectedValue);
