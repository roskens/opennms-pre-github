...
public class SnmpConfigDaoTest extends TestCase {
    ...
    public void setUp() throws Exception {
        ...
        m_configFile = Files.createTempFile(dir, "snmp-config-" + getName() + "-", "xml");
//        m_configFile.deleteOnExit();

        FileUtils.writeStringToFile(m_configFile.toFile(),                "<?xml version=\"1.0\"?>" +
        ...
        SnmpPeerFactory.setPath(m_configFile);
