    ...
    public void testNode() {
        assertLoadAll(OnmsNode.class, new EmptyChecker<OnmsNode>() {
            ...
            public void check(OnmsNode entity) {
                ...
                assertTrue("snmp interfaces list should be greater than or equal to zero",
                           entity.getSnmpInterfaces().size() >= 0);
            }
    ...
    public void testIpInterfaces() {
        assertLoadAll(OnmsIpInterface.class, new EmptyChecker<OnmsIpInterface>() {
            ...
            public void check(OnmsIpInterface entity) {
                ...
                assertTrue("number of monitored services should be greater than or equal to zero",
                           entity.getMonitoredServices().size() >= 0);
            }
    ...
    public void testMonitoredServices() {
        assertLoadAll(OnmsMonitoredService.class, new EmptyChecker<OnmsMonitoredService>() {
            ...
            public void check(OnmsMonitoredService entity) {
                ...
                assertTrue("current outage count should be greater than or equal to zero",
                           entity.getCurrentOutages().size() >= 0);
        ...
        assertLoadAll(OnmsOutage.class, new EmptyChecker<OnmsOutage>() {
            ...
            public void check(OnmsOutage entity) {
                ...
                if (entity.getIfRegainedService() != null) {
                    assertNotNull("outage has ended (ifregainedservice) so service regained event should not be null",
                                  entity.getServiceRegainedEvent());
                    assertNotNull("outage has ended (ifregainedservice) so service regained event UEI should not be null",
                                  entity.getServiceRegainedEvent().getEventUei());
                }
        ...
        assertLoadAll(OnmsEvent.class, new EmptyChecker<OnmsEvent>() {
            ...
            public void check(OnmsEvent entity) {
                if (entity.getAlarm() != null) {
                    assertEquals("event UEI should equal the alarm UEI", entity.getEventUei(),
                                 entity.getAlarm().getUei());
                }
                assertNotNull("associated service lost outages list should not be null",
                              entity.getAssociatedServiceLostOutages());
                assertTrue("there should be zero or more associated service lost outages",
                           entity.getAssociatedServiceLostOutages().size() >= 0);
                assertNotNull("associated service regained outages list should not be null",
                              entity.getAssociatedServiceRegainedOutages());
                assertTrue("there should be zero or more associated service regained outages",
                           entity.getAssociatedServiceRegainedOutages().size() >= 0);
                assertNotNull("dist poller should not be null", entity.getDistPoller());
                assertNotNull("dist poller name should not be null", entity.getDistPoller().getName());
                assertNotNull("notifications list should not be null", entity.getNotifications());
                assertTrue("notifications list size should be greater than or equal to zero",
                           entity.getNotifications().size() >= 0);
            }
    ...
    public void testAlarms() {
        assertLoadAll(OnmsAlarm.class, new EmptyChecker<OnmsAlarm>() {
            ...
            public void check(OnmsAlarm entity) {
                ...
                assertEquals("alarm UEI should match the last event UEI", entity.getUei(),
                             entity.getLastEvent().getEventUei());
                assertNotNull("dist poller should not be null", entity.getDistPoller());
                assertNotNull("dist poller name should not be null", entity.getDistPoller().getName());
            }
