...
public class PropertiesGraphDaoTest {
    ...
    /** The Constant s_baseIncludePrefab. */
    private static final String s_baseIncludePrefab = "command.prefix=foo\n" + "output.mime=image/png\n" + "reports=\n"
            + // Empty for a simple base prefab, with only graphs included from
              // the sub directory
    ...
    /** The Constant s_includedMultiGraph1. */
    ...
    /** The Constant s_includedMultiGraph2. */
    ...
    // A base file, with an include, that defines a single graph, with some
    // unusual and incorrect details
    // that will be overridden by the included graph
    /**
                                                                                     * The
                                                                                     * Constant
                                                                                     * s_mib2bitsBasePrefab
                                                                                     * .
                                                                                     */
    ...
    /**
     * A prefab graphs config with just one of the reports broken in a subtle
     * way (mib2.bits, with it's "name" property spelled "nmae"
    ...
    /** The test specific logging test. */
    ...
    public void testGetCommand() {
        String expectedCommand = "--title=\"Bits In/Out\" " + "DEF:octIn={rrd1}:ifInOctets:AVERAGE "
                + "DEF:octOut={rrd2}:ifOutOctets:AVERAGE " + "CDEF:bitsIn=octIn,8,* " + "CDEF:bitsOut=octOut,8,* "
                + "CDEF:totBits=octIn,octOut,+,8,* " + "AREA:totBits#00ff00:\"Total\" "
                + "GPRINT:totBits:AVERAGE:\" Avg  \\: %8.2lf %s\\n\" " + "LINE2:bitsIn#0000ff:\"Bits In\" "
                + "GPRINT:bitsIn:AVERAGE:\" Avg  \\: %8.2lf %s\" " + "GPRINT:bitsIn:MIN:\"Min  \\: %8.2lf %s\" "
                + "GPRINT:bitsIn:MAX:\"Max  \\: %8.2lf %s\\n\" " + "LINE2:bitsOut#ff0000:\"Bits Out\" "
                + "GPRINT:bitsOut:AVERAGE:\"Avg  \\: %8.2lf %s\" " + "GPRINT:bitsOut:MIN:\"Min  \\: %8.2lf %s\" "
                + "GPRINT:bitsOut:MAX:\"Max  \\: %8.2lf %s\\n\"";
    ...
    /**
     * Test get external values empty.
     */
    @Test
    ...
    /**
     * Test get properties values empty.
     */
    @Test
    ...
    /**
     * Test load snmp graph properties.
     *
     * @throws Exception
     *             the exception
     */
    ...
    public void testLoadSnmpGraphProperties() throws Exception {
        ...
        dao.loadProperties("foo",
                           new FileSystemResource(ConfigurationTestUtils.getFileForConfigFile("snmp-graph.properties")));
    }

    /**
     * Test load snmp adhoc graph properties.
     *
     * @throws Exception
     *             the exception
     */
    ...
    public void testLoadSnmpAdhocGraphProperties() throws Exception {
        PropertiesGraphDao dao = createPropertiesGraphDao(s_emptyMap, s_emptyMap);
        dao.loadAdhocProperties("foo",
                                ConfigurationTestUtils.getInputStreamForConfigFile("snmp-adhoc-graph.properties"));
    }

    /**
     * Test load response time graph properties.
     *
     * @throws Exception
     *             the exception
     */
    ...
    /**
     * Test load response time adhoc graph properties.
     *
     * @throws Exception
     *             the exception
     */
    ...
    public void testLoadResponseTimeAdhocGraphProperties() throws Exception {
        PropertiesGraphDao dao = createPropertiesGraphDao(s_emptyMap, s_emptyMap);
        dao.loadAdhocProperties("foo",
                                ConfigurationTestUtils.getInputStreamForConfigFile("response-adhoc-graph.properties"));
    }

    /**
     * Test prefab properties reload.
     *
     * @throws Exception
     *             the exception
     */
    ...
    /**
     * Test prefab properties reload bad.
     *
     * @throws Exception
     *             the exception
     */
    ...
    public void testOneType() throws Exception {
        ...
        assertTrue("should have responseTime or distributedStatus type",
                   graph.hasMatchingType("responseTime", "distributedStatus"));
    }
    ...
    /**
     * Test get prefab graphs for resource.
     */
    @Test
    ...
    /**
     * Test get prefab graphs for resource with suppress.
     */
    @Test
    ...
    /**
     * Test get prefab graphs for resource with suppress unused.
     */
    @Test
    ...
    /**
     * Creates the properties graph dao.
     *
     * @param prefabConfigs
     *            the prefab configs
     * @param adhocConfigs
     *            the adhoc configs
     * @return the properties graph dao
     * @throws IOException
     *             Signals that an I/O exception has occurred.
     */
    public PropertiesGraphDao createPropertiesGraphDao(Map<String, Resource> prefabConfigs,
            Map<String, Resource> adhocConfigs) throws IOException {
    ...
    /**
     * Test that individual graph files in an include directory are loaded as
     * expected.
     *
     * @throws IOException
     *             Signals that an I/O exception has occurred.
    ...
    public void testPrefabConfigDirectoryMultiReports() throws IOException {
        ...
        // Check the graphs, basically ensuring that a handful of unique but
        // easily checkable
    ...
    /**
     * Test that properties files in an included directory with
     * multiple graphs defined in some, and single graphs in others, are loaded
     * correctly.
     *
     * @throws IOException
     *             Signals that an I/O exception has occurred.
    ...
    /**
     * Test that an included single report per file properties config can
     * override
    ...
    public void testPrefabConfigDirectorySingleReportOverride() throws Exception {
        ...
        PrefabGraph mib2Bits = dao.getPrefabGraph("mib2.bits");
        assertNotNull(mib2Bits);
        // The base properties file (s_mib2bitsBasePrefab) has the name=Wrong
        // Name, and columns=wrongColumn1,wrongColumn2.
        ...
        // with the same data, thus updating the timestamp
        // and forcing a reload. The mib2.bits graph should still be the correct
        // overridden one.
        ...
        // Wait long enough to make the FileReloadContainers do their thing
        // reliably
        Thread.sleep(1100);

        // Ensure that the override still applies and hasn't been "underridden"
        // by the rewrite of the base file.
    ...
    /**
     * Test prefab properties include directory reload single reports.
     *
     * @throws Exception
     *             the exception
     */
    ...
    /**
     * Test that reloading a badly formatted single report doens't overwrite a
     * previously functioning
     * report.
     * NB: It should still complain with an Error log. Should there be an event
     * as well?
     *
     * @throws Exception
     *             the exception
    ...
    public void testPrefabPropertiesIncludeDirectoryBadReloadSingleReport() throws Exception {
        ...
        m_writer = new OutputStreamWriter(m_outputStream, "UTF-8");
        // Two changes:
        // 1) Remove a required property; this should break the reading of the
        // new file
        // 2) Change the externalvalues attribute name; we shouldn't see that
        // new name after the reload
        m_writer.write(s_separateBitsGraph.replace("report.name", "report.fluggle").replace("ifSpeed",
                                                                                            "anotherExternalValue"));
        m_writer.close();
        m_outputStream.close();
    ...
    /**
     * Test that we can load a partly borked config file (i.e. if one graph is
     * incorrectly specified,
     * we load as many of the rest as we can).
     * The borked'ness we can tolerate does not include poor double quoting
     * which confuses the underlying
     * Java properties parser, but misspelled property names should only affect
    ...
    public void testPrefabGraphPartlyBorkedConfig() throws Exception {
        ...
        // We expect to be able to get a mib2.HCbits, and a mib2.discards, but
        // no mib2.bits
        try {
            PrefabGraph mib2bits = dao.getPrefabGraph("mib2.bits");
    ...
    /**
     * Test that adding a "include.directory" property to the main graph config
     * file
    ...
    public void testAddingIncludeDirectory() throws Exception {
        ...
        // Now create the new graph in a sub-directory, and rewrite the rootFile
        // with an include.directory property
        File graphDirectory = m_fileAnticipator.tempDir("snmp-graph.properties.d");
        ...
        assertNotNull(dao.getPrefabGraph("mib2.bits")); // Just checking the
                                                        // reload didn't lose
                                                        // existing graphs
        assertNotNull(dao.getPrefabGraph("mib2.errors")); // This is the core:
                                                          // this graph should
                                                          // have been picked up
    }
    ...
    /**
     * Test include directory include missing report id.
     *
     * @throws Exception
     *             the exception
     */
    ...
    /**
     * It would be nice if having found a new file in the include directory that
     * was malformed, that
     * when it is fixed, it is picked up immediately, rather than having to wait
     * for the next rescan interval.
     *
     * @throws Exception
     *             the exception
     */
    ...
    public void testIncludeNewFileMalformedContentThenFixed() throws Exception {
        // Don't do the normal checking of logging for worse than warning; we
        // expect an error or two to be logged, and that's fine
        testSpecificLoggingTest = true;
        ...
        // Now create the new graph in a sub-directory but make it malformed;
        ...
        // Confirm that the graph still hasn't been loaded (because it was
        // munted)
        try {
            PrefabGraph mib2errors = dao.getPrefabGraph("mib2.errors");
            fail("Should have thrown an ObjectRetrievalFailureException retrieving graph " + mib2errors);
        ...
        // Now set the include rescan interval to a large number, rewrite the
        // graph correctly, and check
        // that the file is loaded (and we don't have to wait for the rescan
        // interval)
        dao.findPrefabGraphTypeByName("performance").setIncludeDirectoryRescanInterval(300000); // 5
                                                                                                // minutes
        m_outputStream = new FileOutputStream(graphErrors);
        m_writer = new OutputStreamWriter(m_outputStream, "UTF-8");
        m_writer.write(s_separateErrorsGraph);
        ...
        // Just make sure any timestamps will be at least 1 second old, just to
        // be sure
        Thread.sleep(1100);

        // And now the graph should have loaded
        try {
            assertNotNull(dao.getPrefabGraph("mib2.errors")); // This is the
                                                              // core: this
                                                              // graph should
                                                              // have been
                                                              // picked up
        } catch (Exception e) {
            // Catch exceptions and fail explicitly, because that's a failure,
            // not an "error"
    ...
    /**
     * Test that when loading graphs from files in the include directory, that
     * if one of
     * the graphs defined in one of the multi-graph files is borked, the rest
     * load correctly
     * Then also check that on setting the reload interval high, that the borked
     * graph is
    ...
    public void testPrefabConfigDirectoryPartlyBorkedMultiReports() throws Exception {
        ...
        // Now set the include rescan interval to a large number, rewrite the
        // multigraph file correctly, and check
        // that the file is loaded (and we don't have to wait for the rescan
        // interval)
        dao.findPrefabGraphTypeByName("performance").setIncludeDirectoryRescanInterval(300000); // 5
                                                                                                // minutes
        ...
        // Just make sure any timestamps will be at least 1 second old, just to
        // be sure that the file timestamp
