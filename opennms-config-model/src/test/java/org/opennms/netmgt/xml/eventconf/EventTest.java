...
public class EventTest extends XmlTestNoCastor<Event> {
    ...
    public static Collection<Object[]> data() throws ParseException {
        ...
        return Arrays.asList(new Object[][] {
                {
                        event0,
                        "<event>" + "<uei>uei</uei>" + "<event-label>event-label</event-label>"
                                + "<descr>descr</descr>" + "<logmsg>log message</logmsg>"
                                + "<severity>normal</severity>" + "</event>", "target/classes/xsds/eventconf.xsd" },
                {
                        event1,
                        "<event xmlns=\"http://xmlns.opennms.org/xsd/eventconf\">"
                                ...
                                + "</event>", "target/classes/xsds/eventconf.xsd" }, });
    }
