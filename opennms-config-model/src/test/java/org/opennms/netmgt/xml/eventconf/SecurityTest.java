...
public class SecurityTest extends XmlTestNoCastor<Security> {
    ...
    public static Collection<Object[]> data() throws ParseException {
        ...
        return Arrays.asList(new Object[][] {
                {
                        security0,
                        "<security>" + "<doNotOverride>I'm very important, don't mess with me!</doNotOverride>"
                                + "</security>", "target/classes/xsds/eventconf.xsd" },
                {
                        security1,
                        "<security>" + "<doNotOverride>I'm very important, don't mess with me!</doNotOverride>"
                                + "<doNotOverride>Also important</doNotOverride>" + "</security>",
