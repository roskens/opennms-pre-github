...
public class OperactionTest extends XmlTestNoCastor<Operaction> {
    ...
    public static Collection<Object[]> data() throws ParseException {
        ...
        return Arrays.asList(new Object[][] {
                { operaction0, "<operaction menutext=\"Test\"></operaction>", "target/classes/xsds/eventconf.xsd" },
                { operaction1, "<operaction menutext=\"Test\" state=\"on\">This is a test</operaction>",
