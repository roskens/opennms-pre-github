...
public class ForwardTest extends XmlTestNoCastor<Forward> {
    ...
    public static Collection<Object[]> data() throws ParseException {
        ...
        return Arrays.asList(new Object[][] { { forward0, "<forward/>", "target/classes/xsds/eventconf.xsd" },
                { forward1, "<forward state=\"on\" mechanism=\"snmpudp\"/>", "target/classes/xsds/eventconf.xsd" } });
    }
