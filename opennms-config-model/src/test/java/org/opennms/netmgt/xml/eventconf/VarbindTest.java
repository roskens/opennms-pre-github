...
public class VarbindTest extends XmlTestNoCastor<Varbind> {
    ...
    public static Collection<Object[]> data() throws ParseException {
        ...
        return Arrays.asList(new Object[][] {
                { varbind0, "<varbind>" + "<vbnumber>5</vbnumber>" + "<vbvalue>0</vbvalue>" + "</varbind>",
                        "target/classes/xsds/eventconf.xsd" },
                {
                        varbind1,
                        "<varbind textual-convention=\"MacAddress\">" + "<vbnumber>5</vbnumber>"
                                + "<vbvalue>0</vbvalue>" + "</varbind>", "target/classes/xsds/eventconf.xsd" } });
    }
