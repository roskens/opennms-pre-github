...
public class TticketTest extends XmlTestNoCastor<Tticket> {
    ...
    public static Collection<Object[]> data() throws ParseException {
        ...
        return Arrays.asList(new Object[][] {
                { tticket0, "<tticket>This is a test</tticket>", "target/classes/xsds/eventconf.xsd" },
                { tticket1, "<tticket state=\"on\">This is a test</tticket>", "target/classes/xsds/eventconf.xsd" } });
    }
