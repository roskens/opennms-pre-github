...
public class AutoacknowledgeTest extends XmlTestNoCastor<Autoacknowledge> {
    ...
    public static Collection<Object[]> data() throws ParseException {
        ...
        return Arrays.asList(new Object[][] {
                { autoacknowledge0, "<autoacknowledge/>", "target/classes/xsds/eventconf.xsd" },
                { autoacknowledge1, "<autoacknowledge state=\"on\">These are important data</autoacknowledge>",
