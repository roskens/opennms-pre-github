        ...
        return Arrays.asList(new Object[][] {
                {
                        ...
                        "<events xmlns=\"http://xmlns.opennms.org/xsd/eventconf\">" + "<event>"
                                + "<uei xmlns=\"\">uei</uei>" + "<event-label>event-label</event-label>"
                                + "<descr>descr</descr>" + "<logmsg>log message</logmsg>"
                                + "<severity>normal</severity>" + "</event>" + "</events>",
                        "target/classes/xsds/eventconf.xsd" },
                {
                        ...
                        "<events>"
                                ...
                                + "</event>" + "<event-file>test</event-file>" + "</events>",
                        "target/classes/xsds/eventconf.xsd" }, });
    }
