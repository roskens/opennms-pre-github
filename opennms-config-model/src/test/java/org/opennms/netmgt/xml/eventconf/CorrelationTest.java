...
public class CorrelationTest extends XmlTestNoCastor<Correlation> {
    ...
    public static Collection<Object[]> data() throws ParseException {
        ...
        return Arrays.asList(new Object[][] {
                { correlation0, "<correlation/>", "target/classes/xsds/eventconf.xsd" },
                {
                        correlation1,
                        "<correlation state=\"on\" path=\"pathOutage\">" + "<cuei>vCuei</cuei>" + "<cmin>cmin</cmin>"
                                + "<cmax>cmax</cmax>" + "<ctime>ctime</ctime>" + "</correlation>",
