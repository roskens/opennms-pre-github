...
public class ScriptTest extends XmlTestNoCastor<Script> {
    ...
    public static Collection<Object[]> data() throws ParseException {
        ...
        return Arrays.asList(new Object[][] {
                { script0, "<script language=\"erlang\"/>", "target/classes/xsds/eventconf.xsd" },
                { script1, "<script language=\"erlang\">This is a test</script>", "target/classes/xsds/eventconf.xsd" }, });
    }
