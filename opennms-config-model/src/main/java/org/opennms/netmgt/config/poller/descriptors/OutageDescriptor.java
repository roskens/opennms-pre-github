...
public class OutageDescriptor extends org.opennms.netmgt.config.poller.descriptors.BasicScheduleDescriptor {
    ...
    public OutageDescriptor() {
        ...
        // -- _interfaceList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.opennms.netmgt.config.poller.Interface.class,
                                                                     "_interfaceList", "interface",
        ...
        // -- _nodeList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.opennms.netmgt.config.poller.Node.class,
                                                                     "_nodeList", "node",
                                                                     org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
