...
public interface CollectionResource extends ResourceIdentifier {
     ...
     * for non interface type collections, otherwise
     * the SNMP type of the interface. Relates to ifType in
     ...
     * "*" for all other resource types defined in the relevant config files,
     * e.g. hrStorage
     *
     ...
     * node level resources, this will be null
     * to indicate the default instance. For interface level resources, some
     * label unique to the node (ifIndex probably)
     * For Generic resources (e.g. the SNMP GenericIndexResource), this will be
     ...
     * use a special timestamp when updating RRDs/JRBs.
     * If the resource doesn't need a special time tracker it should return
     * null.
     *
