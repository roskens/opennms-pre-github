...
public class TimeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public TimeDescriptor() {
        ...
        // -- _day
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_day", "day",
                                                                     org.exolab.castor.xml.NodeType.Attribute);
        desc.setImmutable(true);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
        ...
        desc.setValidator(fieldValidator);
        // -- _begins
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_begins", "begins",
                                                                     org.exolab.castor.xml.NodeType.Attribute);
        desc.setImmutable(true);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
        ...
        desc.setValidator(fieldValidator);
        // -- _ends
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_ends", "ends",
                                                                     org.exolab.castor.xml.NodeType.Attribute);
        desc.setImmutable(true);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
