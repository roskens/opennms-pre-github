...
public class Mbeans implements java.io.Serializable {
    ...
    public Mbean getMbean(final int index) throws java.lang.IndexOutOfBoundsException {
        ...
        if (index < 0 || index >= this._mbeanList.size()) {
            throw new IndexOutOfBoundsException("getMbean: Index value '" + index + "' not in range [0.."
                    + (this._mbeanList.size() - 1) + "]");
        }
    ...
    public void setMbean(final int index, final Mbean vMbean) throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this._mbeanList.size()) {
            throw new IndexOutOfBoundsException("setMbean: Index value '" + index + "' not in range [0.."
                    + (this._mbeanList.size() - 1) + "]");
        }
