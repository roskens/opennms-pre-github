...
public class JmxCollectionDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public JmxCollectionDescriptor() {
        ...
        desc.setSchemaType("org.opennms.netmgt.config.collectd.jmx.Rrd");
        desc.setHandler(handler);
        ...
        desc.setSchemaType("org.opennms.netmgt.config.collectd.jmx.Mbeans");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://xmlns.opennms.org/xsd/config/jmx-datacollection");
        desc.setRequired(true);
        desc.setMultivalued(false);
