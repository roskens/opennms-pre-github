...
public class Configuration implements Serializable {
    ...
    public Configuration(final Integer port, final Integer retry, final Integer timeout, final String readCommunity,
            ...
            final String privacyProtocol, final String enterpriseId) {
        setPort(port);
        setRetry(retry);
        setTimeout(timeout);
    ...
    public boolean equals(final Object obj) {
        ...
        return new EqualsBuilder().append(getPort(), temp.getPort()).append(getRetry(), temp.getRetry()).append(getReadCommunity(),
                                                                                                                temp.getReadCommunity()).append(getWriteCommunity(),
                                                                                                                                                temp.getWriteCommunity()).append(getProxyHost(),
                                                                                                                                                                                 temp.getProxyHost()).append(getVersion(),
                                                                                                                                                                                                             temp.getVersion()).append(getMaxVarsPerPdu(),
                                                                                                                                                                                                                                       temp.getMaxVarsPerPdu()).append(getMaxRepetitions(),
                                                                                                                                                                                                                                                                       temp.getMaxRepetitions()).append(getMaxRequestSize(),
                                                                                                                                                                                                                                                                                                        temp.getMaxRequestSize()).append(getSecurityName(),
                                                                                                                                                                                                                                                                                                                                         temp.getSecurityName()).append(getSecurityLevel(),
                                                                                                                                                                                                                                                                                                                                                                        temp.getSecurityLevel()).append(getAuthPassphrase(),
                                                                                                                                                                                                                                                                                                                                                                                                        temp.getAuthPassphrase()).append(getAuthProtocol(),
                                                                                                                                                                                                                                                                                                                                                                                                                                         temp.getAuthProtocol()).append(getEngineId(),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                        temp.getEngineId()).append(getContextEngineId(),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   temp.getContextEngineId()).append(getContextName(),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     temp.getContextName()).append(getPrivacyPassphrase(),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   temp.getPrivacyPassphrase()).append(getPrivacyProtocol(),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       temp.getPrivacyProtocol()).append(getEnterpriseId(),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         temp.getEnterpriseId()).isEquals();
    }
    ...
    public String toString() {
        return new ToStringBuilder(this).append("port", getPort()).append("retry", getRetry()).append("timeout",
                                                                                                      getTimeout()).append("read-community",
                                                                                                                           getReadCommunity()).append("write-community",
                                                                                                                                                      getWriteCommunity()).append("proxy-host",
                                                                                                                                                                                  getProxyHost()).append("version",
                                                                                                                                                                                                         getVersion()).append("max-vars-per-pdu",
                                                                                                                                                                                                                              getMaxVarsPerPdu()).append("max-repetitions",
                                                                                                                                                                                                                                                         getMaxRepetitions()).append("max-request-size",
                                                                                                                                                                                                                                                                                     getMaxRequestSize()).append("security-name",
                                                                                                                                                                                                                                                                                                                 getSecurityName()).append("security-level",
                                                                                                                                                                                                                                                                                                                                           getSecurityLevel()).append("auth-passphrase",
                                                                                                                                                                                                                                                                                                                                                                      getAuthPassphrase()).append("auth-protocol",
                                                                                                                                                                                                                                                                                                                                                                                                  getAuthProtocol()).append("engine-id",
                                                                                                                                                                                                                                                                                                                                                                                                                            getEngineId()).append("context-engine-id",
                                                                                                                                                                                                                                                                                                                                                                                                                                                  getContextEngineId()).append("context-name",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                               getContextName()).append("privacy-passphrase",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        getPrivacyPassphrase()).append("privacy-protocol",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       getPrivacyProtocol()).append("enterprise-id",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    getEnterpriseId()).toString();
    }
}
