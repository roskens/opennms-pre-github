...
/**
 * Class CompAttribDescriptor.
 *
 * @version $Revision$ $Date$
 */
@SuppressWarnings("all")
public class CompAttribDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    /**
     * Instantiates a new comp attrib descriptor.
     */
    public CompAttribDescriptor() {
        ...
        // -- _compMemberList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(CompMember.class, "_compMemberList",
                                                                     "comp-member",
