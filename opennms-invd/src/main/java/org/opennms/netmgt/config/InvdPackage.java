...
public class InvdPackage {
    private org.opennms.netmgt.config.invd.Package m_pkg;
	private List<String> m_ipList;
	private List<IncludeURL> m_includeURLs;

    public InvdPackage(Package pkg) {
		m_pkg = pkg;
...
//		}
    ...
    void createIpList() {
		org.opennms.netmgt.config.invd.Package pkg = getPackage();
		//
		// Get a list of ipaddress per package agaist the filter rules from
		// database and populate the package, IP list map.
		//
		String filterRules = getFilterRule();
