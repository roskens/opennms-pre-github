...
public class V2TrapInformation extends TrapInformation {
    ...
    protected TrapIdentity getTrapIdentity() {
        ...
        return new TrapIdentity(SnmpObjId.get(snmpTrapOid.getIdentifiers()),
    ...
    protected void validate() {
        ...
        if (m_pdu.typeId() != (byte) (SnmpPduPacket.V2TRAP)) {
            ...
            throw new IllegalArgumentException("Received not SNMPv2 Trap from host " + getTrapAddress() + "PDU Type = "
                    + m_pdu.getCommand());
        }
        ...
        if (varBindName0.equals(V2TrapInformation.EXTREME_SNMP_SYSUPTIME_OID)) {
            LOG.info("V2 trap from {} has been corrected due to the sysUptime.0 varbind not having been sent with a trailing 0.\n\tVarbinds received are : {} and {}",
                     getTrapAddress(), varBindName0, varBindName1);
