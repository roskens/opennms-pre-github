...
public class PollStatus implements Serializable {
    ...
    /**
     * Instantiates a new poll status.
     */
    private PollStatus() {
    ...
    /*
     * stores the individual item for compatibility with database schema, as
     * well as the new property map
     */
    /**
     * <p>
     * setResponseTime
