...
public class MockLogAppender {
     ...
     * @param level
     *            the level
     * @return the events greater or equal
     */
    ...
    /**
     * Gets the single instance of MockLogAppender.
     *
     * @return single instance of MockLogAppender
     */
