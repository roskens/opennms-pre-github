...
public class Table {
        ...
        for (final Constraint constraint : getConstraints()) {
            if (constraint.isPrimaryKeyConstraint()) {
                for (final String constrainedColumn : constraint.getColumns()) {
                    ...
                    if (!foundColumn) {
                        throw new Exception("could not find column '" + constrainedColumn + "' for constraint: "
                                + constraint);
                    }
                }
            }
    ...
    public boolean equals(final Object o) {
        ...
        return new EqualsBuilder().append(getColumns(), other.getColumns()).append(getConstraints(),
                                                                                   other.getConstraints()).append(getName(),
