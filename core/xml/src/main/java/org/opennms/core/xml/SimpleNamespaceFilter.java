...
public class SimpleNamespaceFilter extends XMLFilterImpl {
    ...
    public SimpleNamespaceFilter(final String namespaceUri, final boolean addNamespace) {
        ...
        LOG.debug("SimpleNamespaceFilter initalized with namespace {} ({})", namespaceUri,
                  Boolean.valueOf(addNamespace));
        if (addNamespace) {
    ...
    public void startElement(final String uri, final String localName, final String qName, final Attributes attributes)
            throws SAXException {
        if (m_addNamespace) {
            LOG.trace("start: uri = {}, new uri = {}, localName = {}, qName = {}, attributes = {}", uri,
                      m_namespaceUri, localName, qName, attributes);
            ...
            if (type != null) {
                ...
                for (int i = 0; i < attributes.getLength(); i++) {
                    if (!attributes.getLocalName(i).equals("type")
                        ...
                        att.addAttribute(attributes.getURI(i), attributes.getLocalName(i), attributes.getQName(i),
            ...
            LOG.trace("start: uri = {}, new uri = {}, localName = {}, qName = {}, attributes = {}", uri, uri,
    ...
    public void endElement(final String uri, final String localName, final String qName) throws SAXException {
        if (m_addNamespace) {
            LOG.trace("end:   uri = {}, new uri = {}, localName = {}, qName = {}", uri, m_namespaceUri, localName,
                      qName);
