...
public class Win32V6NativeSocket extends NativeDatagramSocket {
    ...
    /**
     * Instantiates a new win32 v6 native socket.
     *
     * @param family
     *            the family
     * @param type
     ...
     *             the last error exception
     */
    public native int sendto(int socket, Buffer buffer, int buflen, int flags, sockaddr_in6 dest_addr, int dest_addr_len)
            throws LastErrorException;
     ...
     *             the last error exception
     */
    public native int recvfrom(int socket, Buffer buffer, int buflen, int flags, sockaddr_in6 in_addr, int[] in_addr_len)
            throws LastErrorException;
