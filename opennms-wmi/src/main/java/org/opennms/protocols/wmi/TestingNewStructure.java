    ...
    public static void main(final String[] args) {
        try {
            ...
            for (int i = 0; i < wos.count(); i++) {
                ...
                System.out.println("The service (" + propSet.getByName("EventIdentifier").getWmiValue() + ") is: "
                        + propSet.getByName("Message").getWmiValue());
                // for(int b=0; b<propSet.count(); b++) {
                // OnmsWbemProperty prop = propSet.get(b);
                // System.out.println("Property named: " + prop.getWmiName());
                // System.out.println("Property origin: " +
                // prop.getWmiOrigin());
                // System.out.println("Property is array: " +
                // prop.getWmiIsArray());
                // System.out.println("Property is local: " +
                // prop.getWmiIsLocal());
                // System.out.println("Property value: " + prop.getWmiValue());
                // System.out.println("Property CIMType: " +
                // OnmsWbemCimTypeEnum.get(prop.getWmiCIMType()).getCimName() );
                // }
            }
            // lets do some logic here....
            // OnmsWbemObjectSet wos =
            // wmiClient.performInstanceOf("Win32_Keyboard");
            //
            // System.out.println("The number of objects retrieved: " +
            // wos.count());
            // for(int i=0; i<wos.count(); i++) {
            ...
            // System.out.println("object has " + methodSet.getCount() +
            // " methods available.");
            ...
            // System.out.println("Object method Origin: " +
            // method.getWmiOrigin());
            // }
            //
            ...
            // System.out.println("Object ParentNamespace is: " +
            // objPath.getWmiParentNamespace());
            // System.out.println("Object Namespace is: " +
            // objPath.getWmiNamespace());
            // System.out.println("Object Locale is: " +
            // objPath.getWmiLocale());
            // System.out.println("Object DisplayName is: " +
            // objPath.getWmiDisplayName());
            // System.out.println("Object Class is: " + objPath.getWmiClass());
            // System.out.println("Object Authority is: " +
            // objPath.getWmiAuthority());
            // System.out.println("Object RelPath is: " +
            // objPath.getWmiRelPath());
            // System.out.println("Object Server is: " +
            // objPath.getWmiServer());
            // System.out.println("Object IsClass is: " +
            // objPath.getWmiIsClass());
            // System.out.println("Object IsSingleton is: " +
            // objPath.getWmiIsSingleton());
            //
