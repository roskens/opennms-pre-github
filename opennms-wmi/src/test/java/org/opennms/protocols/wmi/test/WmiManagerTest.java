...
public class WmiManagerTest extends TestCase {
    ...
    /**
     * Test that the isValidOpType only returns true for valid operation types
     * such
     ...
     *
     * @throws WmiException
     *             if there are any problems with the WmiManager
     */
    ...
    public final void testInitBadUserPass() throws WmiException {
        ...
        expectLastCall().andThrow(new WmiException(
        ...
        try {
            ...
            assertTrue("Exception missing message: The attempted logon is invalid: " + e,
                       e.getMessage().contains("The attempted logon is invalid"));
        }
        verify(m_WmiMock);
    ...
    public final void testCloseWithInvalidSession() throws WmiException {
        ...
        try {
            ...
            assertTrue("Exception missing message: WmiClient was not initialized: " + e,
                       e.getMessage().contains("WmiClient was not initialized"));
        }
    ...
    public final void testPerformOpInvalidClass() throws WmiException {
        ...
        WmiParams params = new WmiParams(WmiParams.WMI_OPERATION_INSTANCEOF, "2/12/2004 00:00:00", "EQ", "Win32_BISO",
                                         "ReleaseDate");
        // Set up WMI mock client.
        // 1) Expect a call to connect() with a bad hostname.
        // 2) Throw a new WmiException indictating a bad hostname.
        ...
        try {
            ...
            assertTrue("Exception missing message: SWbemServicesEx Invalid class: " + e,
                       e.getMessage().contains("SWbemServicesEx Invalid class"));
        }
    ...
    public final void testPerformOpInvalidObject() throws WmiException {
        ...
        //
        // Create parameter holder.
        WmiParams params = new WmiParams(WmiParams.WMI_OPERATION_INSTANCEOF, "2/12/2004 00:00:00", "EQ", "Win32_BIOS",
                                         "RelDate");
        // Set up WMI mock client.
        // 1) Expect a call to connect() with a bad hostname.
        // 2) Throw a new WmiException indictating a bad hostname.
