 ...
 *
 * <P>This object is used by the Dot1qTpFdbTable to hold information
 * single entries in the table. See the Dot1qTpFdbTable documentation
...
public class Dot1qTpFdbTableTracker extends TableTracker {
	...
	class Dot1qTpFdbRow extends SnmpRowResult {
		...
		public BridgeDot1qTpFdbLink getLink(
    		...
    		BridgeDot1qTpFdbLink link = new BridgeDot1qTpFdbLink(endPointA, endPointB,nodeIdentifier.getNodeid());
	...
	/**
	 * <p>Constructor for Dot1qTpFdbTableEntry.</p>
	 */
