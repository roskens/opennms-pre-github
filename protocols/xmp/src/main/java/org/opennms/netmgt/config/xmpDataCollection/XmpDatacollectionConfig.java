...
public class XmpDatacollectionConfig implements java.io.Serializable {
    ...
    public org.opennms.netmgt.config.xmpDataCollection.XmpCollection getXmpCollection(final int index)
        ...
        if (index < 0 || index >= this._xmpCollectionList.size()) {
            throw new IndexOutOfBoundsException("getXmpCollection: Index value '" + index + "' not in range [0.."
                    + (this._xmpCollectionList.size() - 1) + "]");
        }
    ...
    public void setXmpCollection(final int index,
        ...
        // check bounds for index
        if (index < 0 || index >= this._xmpCollectionList.size()) {
            throw new IndexOutOfBoundsException("setXmpCollection: Index value '" + index + "' not in range [0.."
                    + (this._xmpCollectionList.size() - 1) + "]");
        }
    ...
    public static org.opennms.netmgt.config.xmpDataCollection.XmpDatacollectionConfig unmarshal(
            ...
            org.exolab.castor.xml.ValidationException {
        return (org.opennms.netmgt.config.xmpDataCollection.XmpDatacollectionConfig) Unmarshaller.unmarshal(org.opennms.netmgt.config.xmpDataCollection.XmpDatacollectionConfig.class,
                                                                                                            reader);
    }
