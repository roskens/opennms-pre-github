...
public class Groups implements java.io.Serializable {
     ...
     *            the Vector to copy.
     */
    public void setGroup(final java.util.List<org.opennms.netmgt.config.xmpDataCollection.Group> vGroupList) {
        // copy vector
        this._groupList.clear();
    ...
    public static org.opennms.netmgt.config.xmpDataCollection.Groups unmarshal(final java.io.Reader reader)
        ...
        return (org.opennms.netmgt.config.xmpDataCollection.Groups) Unmarshaller.unmarshal(org.opennms.netmgt.config.xmpDataCollection.Groups.class,
                                                                                           reader);
    }
