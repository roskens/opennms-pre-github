...
@SuppressWarnings("all") public class Rrd implements java.io.Serializable {
     ...
     */
    public static org.opennms.netmgt.config.xmpDataCollection.Rrd unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.opennms.netmgt.config.xmpDataCollection.Rrd) Unmarshaller.unmarshal(org.opennms.netmgt.config.xmpDataCollection.Rrd.class, reader);
    }
