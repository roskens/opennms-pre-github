...
public class Rrd implements java.io.Serializable {
     ...
     *             the validation exception
     */
    public static org.opennms.netmgt.config.nsclient.Rrd unmarshal(final java.io.Reader reader)
            throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.opennms.netmgt.config.nsclient.Rrd) Unmarshaller.unmarshal(org.opennms.netmgt.config.nsclient.Rrd.class,
                                                                               reader);
    }
