...
public class Definition implements java.io.Serializable {
     ...
     *            the Vector to copy.
     */
    public void setIpMatch(final java.util.List<java.lang.String> vIpMatchList) {
        // copy vector
        this._ipMatchList.clear();
     ...
     *            the Vector to copy.
     */
    public void setRange(final java.util.List<org.opennms.netmgt.config.nsclient.Range> vRangeList) {
        // copy vector
        this._rangeList.clear();
     ...
     *            the Vector to copy.
     */
    public void setSpecific(final java.util.List<java.lang.String> vSpecificList) {
        // copy vector
        this._specificList.clear();
    ...
    public static org.opennms.netmgt.config.nsclient.Definition unmarshal(final java.io.Reader reader)
        ...
        return (org.opennms.netmgt.config.nsclient.Definition) Unmarshaller.unmarshal(org.opennms.netmgt.config.nsclient.Definition.class,
                                                                                      reader);
    }
