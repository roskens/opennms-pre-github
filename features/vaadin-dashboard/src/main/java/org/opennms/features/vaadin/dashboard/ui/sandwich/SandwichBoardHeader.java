...
import org.opennms.features.vaadin.dashboard.dashlets.SandwhichMap;
...
public class SandwichBoardHeader extends HorizontalLayout {
    ...
    public SandwichBoardHeader(final SandwichBoardBody sandwichBoardBody) {
        setSpacing(true);
        setWidth("100%");
        ...
        addButton = new Button("Add", new Button.ClickListener() {
            ...
            public void buttonClick(Button.ClickEvent event) {
                try {
                    fieldGroup.commit();
                    sandwichBoardBody.addSandwich(item.getBean());
                    item = new BeanItem<SandwichSpec>(new SandwichSpec());
                    fieldGroup.setItemDataSource(item);
        ...
        pauseButton = new Button("Pause", new Button.ClickListener() {
            ...
            public void buttonClick(Button.ClickEvent event) {
                ...
                sandwichBoardBody.setPaused(paused);
            }
        });
