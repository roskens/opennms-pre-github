                ...
                window.setContent(new VerticalLayout() {
                    {
                        ...
                        final List<DashletFactory> factories = m_wallboardConfigView.getDashletSelector().getDashletFactoryList();
                        ...
                        tree.addValueChangeListener(new Property.ValueChangeListener() {
                            ...
                            public void valueChange(Property.ValueChangeEvent valueChangeEvent) {
                                ...
                                if ("Overview".equals(itemId)) {
                                    ...
                                    DashletFactory dashletFactory = m_wallboardConfigView.getDashletSelector().getDashletFactoryForName(itemId);
