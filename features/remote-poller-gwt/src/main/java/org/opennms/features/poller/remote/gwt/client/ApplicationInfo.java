...
public class ApplicationInfo implements Serializable, IsSerializable, Comparable<ApplicationInfo> {
     ...
     *            object.
     */
    public ApplicationInfo(final int id, final String name, final Set<GWTMonitoredService> services,
            final Set<String> locationNames, final StatusDetails statusDetails) {
        m_id = id;
        m_name = name;
        m_services = services;
    ...
    public int compareTo(final ApplicationInfo that) {
        return new CompareToBuilder().append(this.getStatusDetails(), that.getStatusDetails()).append(this.getPriority(),
                                                                                                      that.getPriority()).append(this.getName(),
                                                                                                                                 that.getName()).append(this.getId(),
    ...
    public String toString() {
        return "ApplicationInfo[id=" + m_id + ",name=" + m_name + ",services=[" + StringUtils.join(m_services, ", ")
                + "],locations=[" + StringUtils.join(m_locations, ", ") + "],status=" + getStatusDetails()
