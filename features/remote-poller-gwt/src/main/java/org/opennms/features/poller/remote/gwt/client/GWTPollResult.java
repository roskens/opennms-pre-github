...
public class GWTPollResult implements Serializable, IsSerializable, Comparable<GWTPollResult> {
    ...
    public String toString() {
        return "GWTPollResult[status=" + m_status + ",timestamp=" + m_timestamp + ",responseTime=" + m_responseTime
                + ",reason=" + m_reason + "]";
    }
    ...
    public int compareTo(GWTPollResult that) {
        return new CompareToBuilder().append(this.getTimestamp(), that.getTimestamp()).append(this.getStatus(),
                                                                                              that.getStatus()).append(this.getResponseTime(),
                                                                                                                       that.getResponseTime()).append(this.getReason(),
                                                                                                                                                      that.getReason()).toComparison();
    }
}
