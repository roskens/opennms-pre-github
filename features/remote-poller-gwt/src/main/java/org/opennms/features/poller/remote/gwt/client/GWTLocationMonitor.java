...
public class GWTLocationMonitor implements Serializable, IsSerializable, Comparable<GWTLocationMonitor> {
    ...
    public int compareTo(GWTLocationMonitor that) {
        return new CompareToBuilder().append(this.getDefinitionName(), that.getDefinitionName()).append(this.getName(),
                                                                                                        that.getName()).append(this.getStatus(),
                                                                                                                               that.getStatus()).append(this.getLastCheckInTime(),
                                                                                                                                                        that.getLastCheckInTime()).toComparison();
    }
}
