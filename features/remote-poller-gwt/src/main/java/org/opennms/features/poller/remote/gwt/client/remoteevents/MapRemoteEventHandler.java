...
public interface MapRemoteEventHandler {
    ...
    /**
     * This action is used to respond to server-side events when a location is
     * updated.
     *
     * @param locationInfo
     *            a
    ...
    /**
     * This action is used to respond to server-side events sent when all
     * initial location updates are complete.
     */
