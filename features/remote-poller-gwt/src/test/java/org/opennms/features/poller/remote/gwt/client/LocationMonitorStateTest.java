...
public class LocationMonitorStateTest {
    ...
    public void testMarkerStatusAllButOneNonStoppedDisconnected() {
        ...
        LocationMonitorState lms = new LocationMonitorState(monitors, statuses);
        assertEquals("status should be marginal if only one monitor started, and more than one disconnected",
    ...
    public void testMarkerStatusSomeReportDownStatus() {
        ...
        LocationMonitorState lms = new LocationMonitorState(monitors, statuses);
        assertEquals("status should be marginal when some services are down", Status.MARGINAL,
    ...
    public void testMarkerStatusOneOfTwoServicesDown() {
        ...
        LocationMonitorState lms = new LocationMonitorState(monitors, statuses);
        assertEquals("status should be down when one service is down across all monitors", Status.DOWN,
                     lms.getStatusDetails().getStatus());
    }
    ...
    public void testMarkerStatusOneServiceDown() {
        ...
        LocationMonitorState lms = new LocationMonitorState(monitors, statuses);
        assertEquals("status should be down when one (of one) service is down across all monitors", Status.DOWN,
                     lms.getStatusDetails().getStatus());
    }
    ...
    public void testMarkerStatusTwoOfTwoServicesDown() {
        ...
        LocationMonitorState lms = new LocationMonitorState(monitors, statuses);
        assertEquals("status should be down when two services (of two) are down across all monitors", Status.DOWN,
                     lms.getStatusDetails().getStatus());
    }
    ...
    public void testMarkerStatusAllNonStoppedMonitorsDisconnected() {
        ...
        LocationMonitorState lms = new LocationMonitorState(monitors, null);
        assertEquals("status should be unknown if all monitors are either disconnected or stopped", Status.UNKNOWN,
                     lms.getStatusDetails().getStatus());
    }
    ...
    public void testMarkerStatusAllRegisteredMonitorsDisconnected() {
        ...
        LocationMonitorState lms = new LocationMonitorState(monitors, null);
        assertEquals("status should be unknown if all registered monitors are disconnected", Status.UNKNOWN,
                     lms.getStatusDetails().getStatus());
    }
