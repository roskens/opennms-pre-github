...
public class SmsSequenceRequest extends MobileSequenceRequest {
    ...
    /**
     * <p>
     * Constructor for SmsSequenceRequest.
     * </p>
     */
    ...
    public void send(MobileSequenceSession session, MobileMsgResponseHandler responseHandler) {
        session.sendSms(getGatewayIdForRequest(), getRecipient(), getText(), getValidityPeriodInHours(),
                        responseHandler);
    }
    ...
    public String toString() {
        return new ToStringBuilder(this).append("gatewayId", getGatewayId()).append("label", getLabel()).append("recipient",
                                                                                                                getRecipient()).append("text",
                                                                                                                                       getText()).toString();
    }
