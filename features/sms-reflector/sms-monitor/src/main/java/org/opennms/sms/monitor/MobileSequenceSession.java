...
public class MobileSequenceSession {
     ...
     *            object.
     */
    public void sendSms(String gatewayId, String recipient, String text, int validityPeriodInHours,
    ...
    public void sendUssd(String gatewayId, String text, MobileMsgResponseHandler responseHandler) {
        ...
        try {
            ...
            request = m_tracker.sendUssdRequest(ussdRequest, getTimeout(), getRetries(), responseHandler,
                                                responseHandler);
        } catch (Throwable e) {
            responseHandler.handleError(request, e);
        }
