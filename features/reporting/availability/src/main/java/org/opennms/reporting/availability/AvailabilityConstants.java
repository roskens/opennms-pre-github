...
public class AvailabilityConstants {
     ...
     */
    public static final String DB_GET_INFO_FOR_IP = "SELECT  node.nodeid, node.nodelabel FROM "
     ...
     * nodeid/IP address.
     */
    public static final String DB_GET_SVC_ENTRIES = "SELECT ifServices.serviceid, service.servicename FROM ifServices, ipInterface, node, "
            + "service WHERE ((ifServices.nodeid = ? ) AND (ifServices.ipaddr = ?) AND ipinterface.ipaddr = ? AND ipinterface.isManaged ='M' AND "
            + "(ifServices.serviceid = service.serviceid) AND (ifservices.status = 'A')) AND node.nodeid = ? AND node.nodetype = 'A'";

    /**
     * The sql statement for getting outage entries for a nodeid/ip/serviceid
     */
    public static final String DB_GET_OUTAGE_ENTRIES = "SELECT ifLostService, ifRegainedService from outages "
    ...
    /**
     * Constant
     * <code>LAST_30_DAYS_DAILY_DESCR="Daily average of svcs and dvcs monitore"{trunked}</code>
     */
    ...
    /**
     * Constant
     * <code>LAST_30_DAYS_TOTAL_LABEL="The last 30 Days Total Availability"</code>
     */
    public static final String LAST_30_DAYS_TOTAL_LABEL = "The last 30 Days Total Availability";

    /**
     * Constant
     * <code>LAST_30_DAYS_TOTAL_DESCR="Average of svcs monitored and availabil"{trunked}</code>
     */
    ...
    /**
     * Constant
     * <code>LAST_30_DAYS_SVC_AVAIL_LABEL="The last 30 days Daily Service Availabi"{trunked}</code>
     */
    public static final String LAST_30_DAYS_SVC_AVAIL_LABEL = "The last 30 days Daily Service Availability";

    /**
     * Constant
     * <code>LAST_30_DAYS_SVC_AVAIL_DESCR="The last 30 days Daily Service Availabi"{trunked}</code>
     */
    ...
    /**
     * Constant
     * <code>LAST_MONTH_SVC_AVAIL_LABEL="The last Months Daily Service Availabil"{trunked}</code>
     */
    public static final String LAST_MONTH_SVC_AVAIL_LABEL = "The last Months Daily Service Availability";

    /**
     * Constant
     * <code>LAST_MONTH_SVC_AVAIL_DESCR="The last Months Daily Service Availabil"{trunked}</code>
     */
    ...
    /**
     * Constant
     * <code>LAST_MTD_DAILY_LABEL="Month To Date Daily Availability"</code>
     */
    public static final String LAST_MTD_DAILY_LABEL = "Month To Date Daily Availability";

    /**
     * Constant
     * <code>LAST_MTD_DAILY_DESCR="Daily Average of svc monitored and avai"{trunked}</code>
     */
    ...
    /**
     * Constant
     * <code>LAST_MTD_TOTAL_LABEL="Month To Date Total Availability"</code>
     */
    public static final String LAST_MTD_TOTAL_LABEL = "Month To Date Total Availability";

    /**
     * Constant
     * <code>LAST_MTD_TOTAL_DESCR="Average of svc monitored and availabili"{trunked}</code>
     */
    ...
    /**
     * Constant
     * <code>LAST_MONTH_DAILY_LABEL="The last Months Daily Availability"</code>
     */
    public static final String LAST_MONTH_DAILY_LABEL = "The last Months Daily Availability";

    /**
     * Constant
     * <code>LAST_MONTH_DAILY_DESCR="Daily Average of svcs monitored and ava"{trunked}</code>
     */
    ...
    /**
     * Constant
     * <code>LAST_MONTH_TOTAL_LABEL="The last Months Total Availability"</code>
     */
    public static final String LAST_MONTH_TOTAL_LABEL = "The last Months Total Availability";

    /**
     * Constant
     * <code>LAST_MONTH_TOTAL_DESCR="Average of svcs monitored and availabil"{trunked}</code>
     */
    ...
    /**
     * Constant
     * <code>NOFFENDERS_DESCR="This is the list of the worst available"{trunked}</code>
     */
    ...
    /**
     * Constant
     * <code>TOP20_SVC_OUTAGES_LABEL="Last Month Top Service Outages for"</code>
     */
    public static final String TOP20_SVC_OUTAGES_LABEL = "Last Month Top Service Outages for";

    /**
     * Constant
     * <code>TOP20_SVC_OUTAGES_DESCR="Last Month Top Service Outages for"</code>
     */
    public static final String TOP20_SVC_OUTAGES_DESCR = "Last Month Top Service Outages for";

    /**
     * Constant
     * <code>NMONTH_TOTAL_LABEL="The last 12 Months Availability"</code>
     */
    public static final String NMONTH_TOTAL_LABEL = "The last 12 Months Availability";

    /**
     * Constant
     * <code>NMONTH_TOTAL_DESCR="The last 12 Months Availability"</code>
     */
