 ...
 * </pre>
 * <p>
 * Copied from {@link org.opennms.netmgt.dao.DatabasePopulator}
 * </p>
 * .
 *
...
public class AvailabilityDatabasePopulator {
    ...
    public void populateDatabase() {
        ...
        setNode1(builder.addNode("test1.availability.opennms.org").setId(1).setType("A").getNode());
        ...
        builder.addNode("test2.availability.opennms.org").setId(2).
        ...
        try {
            ...
            OnmsMonitoredService node1If1Svc1 = getMonitoredServiceDao().get(1, InetAddressUtils.addr("192.168.100.1"),
                                                                             "ICMP");
            OnmsMonitoredService node2If1Svc1 = getMonitoredServiceDao().get(2, InetAddressUtils.addr("192.168.100.2"),
                                                                             "ICMP");
            @SuppressWarnings("unused")
            OnmsMonitoredService node2If1Svc2 = getMonitoredServiceDao().get(2, InetAddressUtils.addr("192.168.100.2"),
                                                                             "SNMP");
            OnmsMonitoredService node2If2Svc1 = getMonitoredServiceDao().get(2, InetAddressUtils.addr("192.168.100.3"),
                                                                             "ICMP");
            @SuppressWarnings("unused")
            OnmsMonitoredService node2If2Svc2 = getMonitoredServiceDao().get(2, InetAddressUtils.addr("192.168.100.3"),
                                                                             "HTTP");
            OnmsOutage outage1 = new OnmsOutage(df.parse("2005-05-01 09:00:00"), df.parse("2005-05-01 09:30:00"),
                                                event, event, node1If1Svc1, null, null);
            getOutageDao().save(outage1);
            getOutageDao().flush();
            OnmsOutage outage2 = new OnmsOutage(df.parse("2005-05-01 10:00:00"), df.parse("2005-05-02 10:00:00"),
                                                event, event, node2If1Svc1, null, null);
            ...
            OnmsOutage outage3 = new OnmsOutage(df.parse("2005-04-02 10:00:00"), df.parse("2005-04-02 10:30:00"),
                                                event, event, node1If1Svc1, null, null);
            getOutageDao().save(outage3);
            getOutageDao().flush();
            // // insert 60 minute outage on one interface and 59 minute outages
            // on
            // // another - 97.2454
            // m_db.update("insert into outages (outageid, nodeid, ipaddr, serviceid, ifLostService, ifRegainedService) values "
            // +
            // "(4,1,'192.168.100.1',1,'2005-04-03 11:30:00','2005-04-03 12:30:00');");
            OnmsOutage outage4 = new OnmsOutage(df.parse("2005-04-03 11:30:00"), df.parse("2005-04-03 12:30:00"),
                                                event, event, node1If1Svc1, null, null);
            ...
            OnmsOutage outage5 = new OnmsOutage(df.parse("2005-04-03 23:00:00"), df.parse("2005-04-03 23:59:00"),
                                                event, event, node2If1Svc1, null, null);
            getOutageDao().save(outage5);
            getOutageDao().flush();
            // // test an outage that spans 60 minutes across midnight -
            // 99.3056% on
            // // each day, well, not exactly
            // // its 29 minutes 99.3059 on the fist day and 31 minutes 99.3052
            // on
            // // the second.
            // m_db.update("insert into outages (outageid, nodeid, ipaddr, serviceid, ifLostService, ifRegainedService) values "
            // +
            // "(6,2,'192.168.100.3',1,'2005-04-04 23:30:00','2005-04-05 00:30:00');");
            OnmsOutage outage6 = new OnmsOutage(df.parse("2005-04-04 23:30:00"), df.parse("2005-04-05 00:30:00"),
                                                event, event, node2If2Svc1, null, null);
