...
/**
 * The Class AvailabilityReportTest.
 */
public class AvailabilityReportTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        /*
         * m_db.update(
         * "insert into ifservices (nodeid, ipaddr, serviceid, status, ipInterfaceId) values "
         * +
         * "(2,'192.168.100.2',2,'A', 2);");
         */
        m_db.update("insert into ifservices (nodeid, ipaddr, serviceid, status, ipInterfaceId) values "
        ...
        // its 29 minutes 99.3059 on the fist day and 31 minutes 99.3052 on the
        // second.
        m_db.update("insert into outages (outageid, nodeid, ipaddr, serviceid, ifLostService, ifRegainedService) values "
    ...
    public void testMyDatabase() {
        ...
        // assertEquals("outages DB count", 3,
        // m_db.countRows("select * from outages"));
        assertEquals("ip interface where ipaddr = 192.168.100.1 count", 1,
