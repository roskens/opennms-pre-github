...
public class DefaultReportStoreService implements ReportStoreService {
    ...
    public Map<String, Object> getFormatMap() {
        ...
        // TODO Tak: This call will be heavy if many RemoteRepositories are
        // involved. Is this method necessary?
     ...
     *            a 
     *            {@link org.opennms.features.reporting.repository.global.GlobalReportRepository}
     *            object
     */
