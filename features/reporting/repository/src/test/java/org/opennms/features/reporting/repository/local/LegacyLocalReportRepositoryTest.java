...
/**
 * <p>
 * LegacyLocalReportRepositoryTest class.
 * </p>
 * <p/>
...
public class LegacyLocalReportRepositoryTest {
    ...
    public void setUp() throws Exception {
        ...
        // TODO indigo: Mockup an InputStream with EasyMock is not trivial,
        // InputStream isn't an interface
        // InputStream jrTemplateStream =
        ...
        // Initialize the local report repository to provide reports from
        // database-reports.xml and jasper-reports.xml
        ...
        // Sanitycheck
        assertNotNull("Test if mocked DAO for database-reports.xml is not null",
                      m_legacyLocalReportRepository.getLocalReportsDao());
        assertNotNull("Test if mocked DAo for jasper-reports.xml is not null",
                      m_legacyLocalReportRepository.getLocalJasperReportsDao());
    }
    ...
    public void testGetReports() throws Exception {
        assertEquals("Test get mocked *ALL* reports from configured local repository", 2,
                     m_legacyLocalReportRepository.getReports().size());
    }
    ...
    public void testGetOnlineReports() throws Exception {
        // TODO indigo: Code covers no test for IllegalAccessException and
        // InvocationTargetException
        assertEquals("Test get mocked *ONLINE* reports from configured local repository", 1,
                     m_legacyLocalReportRepository.getOnlineReports().size());
    }
    ...
    public void testGetReportService() throws Exception {
        // TODO indigo: Code covers no test for IllegalAccessException and
        // InvocationTargetException
        assertEquals("Test get mocket report service from repository by sample-report", "jasperReportServiceMockup",
                     m_legacyLocalReportRepository.getReportService("sample-report"));
    }
    ...
    public void testGetDisplayName() throws Exception {
        assertEquals("Test get mocked display name from repository by sample-report", "displayNameMockup",
                     m_legacyLocalReportRepository.getDisplayName("sample-report"));
    }
    ...
    public void testGetEngine() throws Exception {
        assertEquals("Test get mocked engine from repository by ID", "mocked-jdbc",
                     m_legacyLocalReportRepository.getEngine("sample-report"));
    }
    ...
    public void testGetRepositoryName() throws Exception {
        assertEquals("Test get repository name", "Local Report Repository",
                     m_legacyLocalReportRepository.getRepositoryName());
    }
    ...
    public void testGetRepositoryDescription() throws Exception {
        assertEquals("Test get repository description", "Providing OpenNMS community reports from local disk.",
                     m_legacyLocalReportRepository.getRepositoryDescription());
    }
