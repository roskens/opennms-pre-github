...
public class JdbcDataCollectionConfigTest {
    ...
    public void setUp() throws Exception {
        ...
        jdcc.setRrdRepository(Paths.get("/opt/opennms/share/rrd/snmp/"));
    ...
    public void generateSchema() throws Exception {
        Path schemaFile = fa.expecting("jdbc-datacollection-config.xsd");
    ...
    public void generateXML() throws Exception {
        ...
        Path jdbcCollectionConfig = Paths.get(ClassLoader.getSystemResource("jdbc-datacollection-config.xml").getFile());
        assertTrue("jdbc-datacollection-config.xml is readable", Files.isReadable(jdbcCollectionConfig));
        BufferedReader reader = Files.newBufferedReader(jdbcCollectionConfig, Charset.forName("UTF-8"));
        String line;
        while (true) {
