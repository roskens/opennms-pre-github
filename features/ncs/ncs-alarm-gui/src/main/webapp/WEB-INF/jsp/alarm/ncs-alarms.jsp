    ...
    function submitForm(anAction)
    {
      ...
      %> 
        ...
        <br />
          ...
          <td class="divider">
            <nobr><span title="Event <%= alarms[i].getLastEventID() %>"><a href="event/detail.jsp?id=<%= alarms[i].getLastEventID() %>"><element:formatDate date="${alarm.lastEventTime}"/></a></span></nobr>
            <nobr>
