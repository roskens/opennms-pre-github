...
public class NCSRestServiceTest extends AbstractSpringJerseyRestTestCase {
    ...
    public void testPostAService() throws Exception {
        ...
        for (final NCSComponent component : repo.findAll()) {
            LOG.debug("Found Component: {}/{}/{}", component.getType(), component.getForeignSource(),
    ...
    public void testDeleteAComponent() throws Exception {
        ...
        anticipateEvent(EventConstants.COMPONENT_DELETED_UEI, new String[] { "ServiceElementComponent", "PE2,vcid(50)",
                "NA-SvcElemComp", "9876,vcid(50)" });
        anticipateEvent(EventConstants.COMPONENT_UPDATED_UEI, new String[] { "ServiceElement", "PE2,ge-3/1/4",
                "NA-ServiceElement", "9876,4321" });
    ...
    public void testAddComponents() throws Exception {
        ...
        anticipateEvent(EventConstants.COMPONENT_UPDATED_UEI, new String[] { "ServiceElement", "PE2,ge-3/1/4",
                "NA-ServiceElement", "9876,4321" });
        anticipateEvent(EventConstants.COMPONENT_ADDED_UEI, new String[] { "ServiceElementComponent", "Monkey (1)",
                "NA-SvcElemComp", "monkey1" });
        anticipateEvent(EventConstants.COMPONENT_ADDED_UEI, new String[] { "PhysicalInterface", "Shoe (2)",
                "NA-PhysIfs", "shoe2" });
    ...
    public void testDeleteOrphans() throws Exception {
        ...
        m_eventAnticipator.reset();
        anticipateEvent(EventConstants.COMPONENT_UPDATED_UEI, new String[] { "ServiceElementComponent", "PE2,vcid(50)",
                "NA-SvcElementComp", "9876,vcid(50)" });
        anticipateEvent(EventConstants.COMPONENT_DELETED_UEI, new String[] { "ServiceElementComponent", "lspA-PE2-PE1",
                "NA-SvcElemComp", "9876,LSP-1234" });
        anticipateEvent(EventConstants.COMPONENT_DELETED_UEI, new String[] { "ServiceElementComponent", "lspB-PE2-PE1",
                "NA-SvcElemComp", "9876,LSP-4321" });
    ...
    public void testDeleteOrphansRecursive() throws Exception {
        ...
        anticipateEvent(EventConstants.COMPONENT_UPDATED_UEI,
                        new String[] { "Service", "CokeP2P", "NA-Service", "123" });
    ...
    public void testDeleteMultiParentOrphans() throws Exception {
        ...
        anticipateEvent(EventConstants.COMPONENT_UPDATED_UEI, new String[] { "child1", "Child1-2", "child1Fs1",
                "child1Fd2" });
        anticipateEvent(EventConstants.COMPONENT_DELETED_UEI, new String[] { "child1", "Child1-1", "child1Fs1",
                "child1Fd1" });
    ...
    private void createMultiParent() throws Exception {
        ...
        anticipateEvent(EventConstants.COMPONENT_ADDED_UEI, new String[] { "child1", "Child1-1", "child1Fs1",
                "child1Fd1" });
        anticipateEvent(EventConstants.COMPONENT_ADDED_UEI, new String[] { "child2", "Child2-1", "child2Fs1",
                "child2Fd1" });
        ...
        text = ""
                ...
                + "      <name>Child2-1</name>\n" + "    </component>\n" + "  </component>\n";
        anticipateEvent(EventConstants.COMPONENT_UPDATED_UEI, new String[] { "top", "Top1", "topFs1", "topFd1" });
        anticipateEvent(EventConstants.COMPONENT_ADDED_UEI, new String[] { "child1", "Child1-2", "child1Fs1",
                "child1Fd2" });
        anticipateEvent(EventConstants.COMPONENT_UPDATED_UEI, new String[] { "child2", "Child2-1", "child2Fs1",
                "child2Fd1" });
