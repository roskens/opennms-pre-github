...
public class EventMappingRulesTest extends CorrelationRulesTestCase {
    ...
    public void testMapPwDown() throws Exception {
        ...
        testEventMapping(event, ComponentDownEvent.class, "ServiceElementComponent", "NA-SvcElemComp",
    ...
    public void testDupPwDown() throws Exception {
        ...
        testEventDup(event, event2, ComponentDownEvent.class, "ServiceElementComponent", "NA-SvcElemComp",
                     "9876,jnxVpnPw-vcid(50)");
    ...
    public void testMapPwUp() throws Exception {
        ...
        testEventMapping(event, ComponentUpEvent.class, "ServiceElementComponent", "NA-SvcElemComp",
                         "9876,jnxVpnPw-vcid(50)");
