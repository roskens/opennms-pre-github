...
/**
 * The Class SearchStateTest.
 */
@RunWith(PowerMockRunner.class)
@PrepareForTest({ NativeEvent.class, EventTarget.class, VConsole.class, History.class, HistoryImpl.class,
        Scheduler.class, SchedulerImpl.class })
@SuppressStaticInitializationFor({ "com.google.gwt.dom.client.NativeEvent", "com.google.gwt.dom.client.EventTarget",
        "com.google.gwt.dom.client.InputElement", "com.google.gwt.user.client.History",
        "com.google.gwt.user.client.HistoryImpl", "com.google.gwt.core.client.Scheduler",
...
public class SearchStateTest {
     ...
     * m_searchManager = new MockSearchStateManager(m_mockSearchInput,
     * m_mockHistory);
     * }
     * @Test
     ...
     * assertEquals(State.SEARCHING_AUTOCOMPLETE_VISIBLE,
     * m_searchManager.getState());
     ...
     * assertEquals(State.SEARCHING_AUTOCOMPLETE_HIDDEN,
     * m_searchManager.getState());
     * assertEquals(false, m_searchManager.isAutocompleteVisible());
     * assertEquals(false, m_searchManager.isAutocompleteFocused());
     * assertEquals(true, m_searchManager.isInputFocused());
     ...
     * // autocomplete shouldn't do anything even if we down-arrow, since we
     ...
     * typeCharacter(m_searchManager, (char)KeyCodes.KEY_DOWN);
     * m_searchManager.updateMatchCount(15);
     * assertEquals(State.SEARCHING_AUTOCOMPLETE_ACTIVE,
     * m_searchManager.getState());
     * assertEquals(true, m_searchManager.isAutocompleteVisible());
     ...
     * }
     * @Test
     * public void testSelectingItemInAutocompleteBoxThenSearchingAgain() throws
     * Exception {
     * typeCharacter(m_searchManager, 'a');
     * m_searchManager.updateMatchCount(15);
     * typeCharacter(m_searchManager, (char)KeyCodes.KEY_DOWN);
     ...
     * }
     * protected void clickAutocompleteEntry(final MockSearchStateManager
     * searchManager) throws Exception {
     * searchManager.handleAutocompleteEvent(createEvent("click", 0));
     * }
     * protected void hitEnterInAutocompleteField(final MockSearchStateManager
     * searchManager) throws Exception {
     * searchManager.handleAutocompleteEvent(createEvent("keydown",
     * KeyCodes.KEY_ENTER));
     * }
     * protected void hitCancelX(final MockSearchStateManager searchManager)
     * throws Exception {
     * m_mockSearchInput.setValue("");
     * searchManager.handleInputEvent(createEvent("search", 0));
     * }
     * protected void hitEnterInInput(final MockSearchStateManager
     * searchManager) throws Exception {
     * searchManager.handleInputEvent(createEvent("keydown",
     * KeyCodes.KEY_ENTER));
     * }
     * protected void typeCharacter(final MockSearchStateManager searchManager,
     * final char keyCode) throws Exception {
     ...
     * VConsole.log("backspace!  old=" + value + ", new=" +
     * m_mockSearchInput.getValue());
     * }
     * } else {
     ...
     * }
     * protected NativeEvent createEvent(final String type, final int keyCode)
     * throws Exception {
     ...
     * @Override public void printLayoutProblems(ValueMap meta,
     * ApplicationConnection applicationConnection, Set<ComponentConnector>
     * zeroHeightComponents, Set<ComponentConnector> zeroWidthComponents) {}
     ...
     * public MockSearchStateManager(final ValueItem searchString, final
     * ValueItem history) {
