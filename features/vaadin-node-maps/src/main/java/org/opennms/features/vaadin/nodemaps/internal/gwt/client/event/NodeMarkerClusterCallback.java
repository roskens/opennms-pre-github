...
public class NodeMarkerClusterCallback implements MarkerClusterEventCallback {
    ...
    public final void run(final MarkerClusterEvent event) {
        ...
        if (markers.size() == 1) {
            ...
            for (final NodeMarker marker : markers) {
                ...
                nodeBuilder.append("<a class=\"node\" href=\"element/node.jsp?node=").append(marker.getNodeId()).append("\" "
                                                                                                                                + TARGET_NONE
                                                                                                                                + ">").append(marker.getNodeLabel()).append("</a>");
                ...
                nodeBuilder.append("<a href=\"alarm/list.htm?sortby=id&acktype=unack&limit=20&filter=node%3D").append(marker.getNodeId()).append("\" "
                                                                                                                                                         + TARGET_BLANK
                                                                                                                                                         + ">").append(marker.getSeverityLabel()).append("</a>");
                nodeBuilder.append("</td>");
    ...
    public static String getPopupTextForMarker(final NodeMarker marker) {
        // TODO: THIS IS AWFUL
        final StringBuilder sb = new StringBuilder();
        sb.append("<h2>Node <a class=\"node\" href=\"element/node.jsp?node=").append(marker.getNodeId()).append("\" "
                                                                                                                        + TARGET_NONE
                                                                                                                        + ">").append(marker.getNodeLabel()).append("</a></h2>");
        sb.append("<p>");
        ...
        sb.append("Severity: ").append("<a class=\"severity "
                                               + marker.getSeverityLabel()
                                               + "\" href=\"alarm/list.htm?sortby=id&acktype=unack&limit=20&filter=node%3D").append(marker.getNodeId()).append("\" "
                                                                                                                                                                       + TARGET_BLANK
                                                                                                                                                                       + ">").append(marker.getSeverityLabel()).append("</a>");
