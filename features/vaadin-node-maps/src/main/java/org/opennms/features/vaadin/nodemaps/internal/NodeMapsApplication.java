 ...
 * <li>http://developers.cloudmade.com/projects/web-maps-api/examples/marker-
 * clustering</li>
 * </ul>
 *
 ...
 * 1) Several nodes can share the exact location, so we should determinate the
 * points and associate a
 * list of nodes to it.
 * 2) Regions are polygons that contains a list of points (nodes or group of
 * nodes).
 */
/*
 * Display Strategies
 * 1. Create the NodePoints object
 * (which is essentially Map<PointVector,List<OnmsNode>>, or
 * Map<PointVector,List<Integer>>).
 ...
 * 5. Create a strategy to build/display the Popups even using Vaadin Widgets or
 * OpenLayer widgets).
 */
...
@JavaScript({ "http://maps.google.com/maps/api/js?sensor=false",
        "http://cdn.leafletjs.com/leaflet-0.5.1/leaflet-src.js", "gwt/public/openlayers/OpenLayers.js",
        "gwt/public/markercluster/leaflet.markercluster-src.js"

})
@StyleSheet({ "gwt/public/markercluster/MarkerCluster.css", "gwt/public/markercluster/MarkerCluster.Default.css",
...
public class NodeMapsApplication extends UI {
    ...
    public void setHeaderHtml(final String headerHtml) {
        ...
        /**
         * Added some magic to hide search controls and header if displayed
         * inside an iframe
         */
