...
@ContextConfiguration(locations = { "classpath:/META-INF/opennms/junit-component-dao.xml",
...
public class TcaCollectorTest implements InitializingBean {
    ...
    public void testCollector() throws Exception {
        ...
        OneToOnePersister persister = new OneToOnePersister(new ServiceParameters(parameters),
                                                            collector.getRrdRepository("default"));
        ...
        RrdDb jrb = new RrdDb(TEST_SNMP_DIR + "/1/" + TcaCollectionResource.RESOURCE_TYPE_NAME + "/171.19.37.60/"
                + TcaCollectionSet.INBOUND_DELAY + ".jrb");
     ...
     * <p>
     * Each collection set must contain:<br>
     * 25 Samples of each of 2 peers = 50 resources
     * </p>
     *
     * @param collectionSet
     *            the collection set
