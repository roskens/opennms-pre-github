...
public class TcaDataCollectionConfigTest {
    ...
    public void generateXML() throws Exception {
        ...
        assertTrue(TcaDataCollectionConfig.TCA_DATACOLLECTION_CONFIG_FILE + " is readable",
                   tcaCollectionConfig.canRead());
        BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream(tcaCollectionConfig),
                                                                         "UTF-8"));
        String line;
        while (true) {
    ...
    private File getSourceFile() {
        File tcaCollectionConfig = new File("src/test/resources/etc/",
                                            TcaDataCollectionConfig.TCA_DATACOLLECTION_CONFIG_FILE);
