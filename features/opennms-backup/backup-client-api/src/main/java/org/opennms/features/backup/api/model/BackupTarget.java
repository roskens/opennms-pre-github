...
/**
 * This interface describes the target of a backup operation.
 *
 * @author Christian Pape
 */
public interface BackupTarget extends BackupSource {
    /**
     * Returns the {@link Set} of diff files
     *
    ...
    /**
     * Checks whether this target contains the diff file with the given name.
     *
