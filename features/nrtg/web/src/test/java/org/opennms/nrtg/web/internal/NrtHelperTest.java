...
public class NrtHelperTest {
    ...
    public void testStringProperties () {
        String rawString = "--title='Current TCP Connections'"
                + " --vertical-label='Current Connections ({ifSpeed})'"
                ...
                + " GPRINT:currEstab:AVERAGE:'Avg  \n: %8.2lf %s'"
                + " GPRINT:currEstab:MIN:'Min  \n: %8.2lf %s'"
                + " GPRINT:currEstab:MAX:'Max  \n: %8.2lf %s\n'";
    ...
    public void testGenerateMetricMappingSystemMemoryStats() {
        ...
        String rawString = "--title=\"System Memory Stats\""
                + " --width 565"
                + " --height 200"
                + " --lower-limit 0"
                + " --base=1024"
                ...
                + " STACK:memavailswapBytes#ff0000:\"Total Swap    \""
                ...
                + " LINE2:memtotalrealBytes#0000ff:\"Total Real Mem\""
    ...
    public void testGenerateMetricMappingTcpOpenConnections() {
        ...
        String rawString = "--title=\"TCP Open Connections\""
    ...
    public void testGenerateMetricMappingTca() {
        ...
        String rawString = "--watermark=\"NRTG Alpha 1.0\""
                + " --slope-mode"
                + " --width=960"
                + " --height=400"
                + " --title=\"TCA Delay\""
