...
public class AddVertexToGroupOperation implements Constants, Operation {
     ...
     * <ul>
     * <li>If the target is selected, than all selected vertices including the
     * target are ŕeturned.</li>
    ...
    /**
     * This method removes all children of the given selection. This is
     * necessary, because if a group is selected, we only want
    ...
    public Undoer execute(List<VertexRef> targets, final OperationContext operationContext) {
        ...
        final Collection<VertexRef> vertices = removeChildren(operationContext.getGraphContainer().getBaseTopology(),
                                                              determineTargets(targets.get(0),
                                                                               operationContext.getGraphContainer().getSelectionManager()));
            ...
            public Field<?> createField(Item item, Object propertyId, Component uiContext) {
                ...
                if ("Group".equals(pid)) {
                    ...
                    select.addValidator(new Validator() {
                        ...
                        /**
                         * Ensures that if only one element is selected that
                         * this element cannot be added to itself.
                         * If there are more than one elements selected, we
                         * assume as valid.
                         */
        ...
        final Form promptForm = new Form() {
            ...
            public void commit() throws SourceException, InvalidValueException {
                ...
                Vertex group = graphContainer.getBaseTopology().getVertex(graphContainer.getBaseTopology().getVertexNamespace(),
                                                                          groupId);
