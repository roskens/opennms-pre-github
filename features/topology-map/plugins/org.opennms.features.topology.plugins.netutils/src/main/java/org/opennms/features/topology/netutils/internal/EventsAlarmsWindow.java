 ...
 * contains an embedded browser for both the Events page and Alarm page of the
 * selected node.
...
public class EventsAlarmsWindow extends Window {
    ...
    /**
     * The EventsAlarmsWindow method constructs a sub-window instance which can
     * be added to a
     * main window. The sub-window contains two embedded browsers which are
     * directed at the Events
