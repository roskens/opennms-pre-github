...
/**
 * The NodeInfoWindow class constructs a custom Window component that contains
 * an embedded
...
public class NodeInfoWindow extends InfoWindow {
    ...
    /**
     * The NodeInfoWindow method constructs a sub-window instance which can be
     * added to a main window.
     * The sub-window contains an embedded browser which displays the Node Info
     * page of the currently selected
     * node.
     *
     * @param node
     *            Selected node
