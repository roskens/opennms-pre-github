...
public class TerminalTest {
    ...
    public void testDump() {
        ...
        try {
            expected = term.dump();
            assertTrue(expected.contains(tags)); // testing default html tags
                                                 // from empty dump

            term.write("& < >");
            expected = term.dump();
            assertTrue(expected.contains("&amp; &lt; &gt;")); // testing
                                                              // html-escaped
                                                              // characters
            ...
            expected = term.dump();
            assertTrue(expected.contains("underlinedText")); // testing
                                                             // underlined
                                                             // texted
    ...
    public void testPipe_A() {
        String expected = "A";
        String input = "A";
        assertEquals(expected, term.pipe(input)); // testing normal character
                                                  // writing
    }
    ...
    public void testPipe_2tildas() {
        String expected = "~";
        String input = "~~";
        assertEquals(expected, term.pipe(input)); // testing 2 consecutive
                                                  // tilda's
    }
    ...
    public void testPipe_control_nums() {
        ...
        expected = "";
        input = "~5";
        assertEquals(expected, term.pipe(input)); // testing non-existent
                                                  // control sequence
    }
    ...
    public void testPipe_cm_nums() {
        ...
        expected = "";
        input = "~5";
        assertEquals(expected, term.pipe(input)); // testing non-existence
                                                  // cursor-mode numeric control
                                                  // sequence
    }
    ...
    public void testPipe_cm_tilda() {
        ...
        String input = "~~";
        term.write("\u001b[?1h");
        assertEquals(expected, term.pipe(input)); // testing cursor-mode tilda
                                                  // control sequence
    }
    ...
    public void testRead() {
        ...
        term.write("\u001b[c");
        assertEquals("\u001b[?1;2c", term.read()); // testing a read after a
    ...
    public void testWrite() {
        ...
        term.write("\u001b[" + (char) 25); // checking non-existent sequence
                                           // between 24 and 26
        ...
        assertTrue(term.write("\u001b[!p")); // test passes if the term writes
