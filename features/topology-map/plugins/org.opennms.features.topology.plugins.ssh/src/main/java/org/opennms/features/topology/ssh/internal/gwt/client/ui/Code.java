...
/**
 * The Code class takes generic KeyEvents and extracts all relevant information
 * from them.
 *
...
public class Code {
    ...
    /**
     * The Code(KeyEvent event) constructor takes a generic KeyEvent and decides
     * whether
     * it is a KeyPressEvent or KeyDownEvent. Any relevant information about the
     * event
