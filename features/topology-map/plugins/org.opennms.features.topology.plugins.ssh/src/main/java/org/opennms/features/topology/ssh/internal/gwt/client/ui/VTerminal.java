...
/**
 * The VTerminal class is associated with the GwtTerminal widget and handles all
 * of the communication
 * from the client and sends it to the server. It also listens for responses
 * from the server and
...
public class VTerminal extends GwtTerminal implements Paintable {
    ...
    /**
     * The update method is used by the server whenever it requests an update
     * from
     * the TermHandler in order to receive the current key presses from the
     * client.
     */
    public void update() {
        termHandler.update();
    ...
    /**
     * The updateFromUIDL method handles all communication from the server and
     * passes
