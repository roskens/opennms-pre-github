...
public interface SystemReportPlugin extends Comparable<SystemReportPlugin> {
    ...
    /**
     * Get the priority of this plugin. This will be used to sort the various
     * plugins' output when creating an aggregate report.
     * 1-10: system-level plugins
     * 11-50: related to core system functionality (eg, events, alarms,
     * notifications)
