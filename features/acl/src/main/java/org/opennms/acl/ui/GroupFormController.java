...
public class GroupFormController {
    ...
    protected String processSubmit(@ModelAttribute("group") OnmsGroup group, BindingResult result, SessionStatus status) {
    ...
    public String setupForm(@RequestParam(required = false, value = "gid") Integer id, ModelMap model) {
        model.addAttribute(Constants.GROUP, id == null ? new OnmsGroup() : groupService.getGroup(id));
        return groupForm;
    }
    ...
    private final String groupForm = "acl/group/form";
}
