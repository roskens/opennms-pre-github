...
public class Constants {
    ...
    /**
     * Constant
     * <code>MSG_AUTHORITY_DELETE_SUCCESS="authority.delete.success"</code>
     */
    public static String MSG_AUTHORITY_DELETE_SUCCESS = "authority.delete.success";

    /**
     * Constant
     * <code>MSG_AUTHORITY_DELETE_FAILURE="authority.delete.failure"</code>
     */
    public static String MSG_AUTHORITY_DELETE_FAILURE = "authority.delete.failure";

    /**
     * Constant
     * <code>REDIRECT_AUTHORITY_LIST="redirect:authority.list.page"</code>
     */
    ...
    /**
     * Constant
     * <code>REDIRECT_USER_AUTHORITIES="redirect:user.authorities.page"</code>
     */
