...
/**
 * This class provides an API for implementing provider "extensions" to the
 * OpenNMS
 * Provisioning daemon.
 *
...
public interface ProvisioningAdapter {
    ...
    /**
     * This method is called when a configuration change event has occurred from
     * any source. Typically,
     * Traps sent from a device are converted to an event and that event is then
    ...
    /**
     * This method is called in case the adapter needs to perform some
