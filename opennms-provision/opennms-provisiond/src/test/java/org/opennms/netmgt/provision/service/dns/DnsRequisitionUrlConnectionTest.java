...
public class DnsRequisitionUrlConnectionTest {
    ...
    public void dwoValidateMultipathUrl() {
        ...
        Assert.assertEquals("The specified DNS URL contains invalid path: dns://localhost/org/opennms/raleigh",
    ...
    public void dwoValidateInvalidQueryParmInUrl() {
        ...
        Assert.assertNotNull(e);
        Assert.assertEquals("The specified DNS URL contains an invalid query string: dns://localhost/opennms/?string=abc[123]",
                            e.getLocalizedMessage());
    ...
    public void dwoUrlAsResource() throws IOException, MarshalException, ValidationException, JAXBException {
        ...
        Assert.assertEquals("should have 2 A records: 1 for example.com, and 1 for www.example.com", 2,
                            req.getNodeCount());
    ...
    public void dwoUrlAsResourceUsingMatchingExpression() throws IOException, MarshalException, ValidationException,
            JAXBException {
    ...
    @JUnitDNSServer(port = 9153, zones = { @DNSZone(name = "example.com", entries = {
            @DNSEntry(hostname = "www", address = "72.14.204.99"),
            @DNSEntry(hostname = "monkey", address = "72.14.204.99") }) })
    public void dwoUrlAsResourceUsingNonMatchingExpression() throws IOException, MarshalException, ValidationException,
            JAXBException {
