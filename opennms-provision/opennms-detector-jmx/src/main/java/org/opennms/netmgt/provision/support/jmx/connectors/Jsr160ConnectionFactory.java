...
/**
 * This class creates a connection to the remote server. There are many options
 * to using this
...
public class Jsr160ConnectionFactory {
     ...
     * @return a
     *         {@link org.opennms.netmgt.provision.support.jmx.connectors.Jsr160ConnectionWrapper}
     *         object.
     */
    public static Jsr160ConnectionWrapper getMBeanServerConnection(Map<String, Object> propertiesMap,
            InetAddress address) {
    ...
    private static Jsr160ConnectionWrapper getWrapper(InetAddress address, String factory, int port, String protocol,
        ...
        if (factory == null || factory.equals("STANDARD")) {
            try {
                ...
                url = new JMXServiceURL("service:jmx:" + protocol + ":///jndi/" + protocol + "://" + hostAddress + ":"
                        + port + urlPath);
         ...
         * // connect it to the RMI connector server
         * //
         * JMXServiceURL url = new JMXServiceURL(protocol, hostAddress, port,
         * urlPath);
         * // Connect a JSR 160 JMXConnector to the server side
