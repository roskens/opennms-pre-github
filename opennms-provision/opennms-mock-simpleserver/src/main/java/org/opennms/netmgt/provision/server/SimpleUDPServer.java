...
public class SimpleUDPServer {
    ...
    public static class SimpleServerExchange implements Exchange {
        ...
        public boolean processRequest(DatagramSocket socket) throws IOException {
            ...
            DatagramPacket packet = new DatagramPacket(data, data.length, socket.getLocalAddress(),
                                                       socket.getLocalPort());
     ...
     *            a {@link java.net.DatagramPacket} object.
     * @return a
     *         {@link org.opennms.netmgt.provision.server.SimpleUDPServer.RequestMatcher}
     *         object.
     */
