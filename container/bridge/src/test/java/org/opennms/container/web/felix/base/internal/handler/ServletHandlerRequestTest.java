...
public class ServletHandlerRequestTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
                { createRequest("/opennms", "/mib-compiler", null), "/mib-compiler", "/opennms", "/mib-compiler", null },
                { createRequest("/opennms", "/VAADIN/themes/runo/styles.css", null), "/VAADIN", "/opennms", "/VAADIN",
                        "/themes/runo/styles.css" },
                { createRequest("/opennms", "/osgi", "/mib-compiler/UIDL"), "/mib-compiler", "/opennms/osgi",
                        "/mib-compiler", "/UIDL" },
                { createRequest("/opennms", "/mib-compiler/UIDL", null), "/mib-compiler", "/opennms", "/mib-compiler",
                        "/UIDL" } });
    }
