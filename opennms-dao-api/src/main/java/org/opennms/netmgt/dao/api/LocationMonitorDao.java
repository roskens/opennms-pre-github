...
public interface LocationMonitorDao extends OnmsDao<OnmsLocationMonitor, Integer> {
     ...
     *
     * @param status
     *            a {@link org.opennms.netmgt.model.OnmsLocationSpecificStatus}
     *            object.
     */
     ...
     *            object.
     * @return a {@link org.opennms.netmgt.model.OnmsLocationSpecificStatus}
     *         object.
     */
    OnmsLocationSpecificStatus getMostRecentStatusChange(final OnmsLocationMonitor locationMonitor,
     ...
     * @param endDate
     *            a {@link java.util.Date} object.
     * @param locationDefinitionName
     *            a {@link java.lang.String} object.
     * @return a {@link java.util.Collection} object.
     */
    Collection<OnmsLocationSpecificStatus> getStatusChangesForLocationBetween(final Date startDate, final Date endDate,
            final String locationDefinitionName);
     ...
     * @since 1.8.1
     */
    Collection<OnmsLocationSpecificStatus> getStatusChangesForApplicationBetween(final Date startDate,
     ...
     * @return a {@link java.util.Collection} object.
     */
    Collection<OnmsLocationSpecificStatus> getStatusChangesBetweenForApplications(final Date startDate,
    ...
    /**
     * Mark all location monitors as paused except those that are already
     * stopped
     */
    void pauseAll();
