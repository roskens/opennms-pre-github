...
public interface Pinger {
    ...
    /**
     * Ping a remote host, sending 1 or more packets at the given interval, and
     * then
     ...
     *            The time to wait between each retry.
     * @param pingInterval
     *            The interval at which packets will be sent.
    ...
    /**
     * Initialize IPv4 in this Pinger implementation. If unable to do so,
    ...
    /**
     * Initialize IPv6 in this Pinger implementation. If unable to do so,
     * implementations should throw an exception.
     *
     * @throws Exception
     */
