...
final public class SshMonitor extends AbstractServiceMonitor {
     ...
     */
    public PollStatus poll(InetAddress address, Map<String,?> parameters) {
        ...
        if (match == null && (banner == null || banner.equals("*"))) {
            ...
            try {
				...
				log().error("Match '" + match + "' is an invalid regular expression", e);
			}
        } else if (banner != null) {
            try {
				regex = new RE(banner);
			} catch (RESyntaxException e) {
				log().error("Banner '" + banner + "' is an invalid regular expression", e);
			}
        }
