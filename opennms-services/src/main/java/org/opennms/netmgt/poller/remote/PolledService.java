...
public class PolledService implements MonitoredService, Serializable, Comparable<PolledService> {
     ...
     *            object.
     */
    public PolledService(final OnmsMonitoredService monitoredService, final Map<String, Object> monitorConfiguration,
            final OnmsPollModel pollModel) {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder(3, 57).append(this.getNodeId()).append(this.getIpAddr()).append(this.getServiceId()).toHashCode();
    }
    ...
    public boolean equals(final Object o) {
        ...
        return new EqualsBuilder().append(this.getNodeId(), that.getNodeId()).append(this.getIpAddr(), that.getIpAddr()).append(this.getServiceId(),
                                                                                                                                that.getServiceId()).isEquals();
    }
        ...
        return new CompareToBuilder().append(this.getNodeId(), that.getNodeId()).append(this.getNodeLabel(),
                                                                                        that.getNodeLabel()).append(this.getIpAddr(),
                                                                                                                    that.getIpAddr()).append(this.getSvcName(),
                                                                                                                                             that.getSvcName()).append(this.getServiceId(),
