...
public final class FtpMonitor extends AbstractServiceMonitor {
    ...
    /**
     * {@inheritDoc} Poll the specified address for FTP service availability.
            ...
            try {
                ...
                if (bannerResponse.isSuccess()) {
                    ...
                    if (userid == null || userid.length() == 0 || password == null || password.length() == 0) {
                        ...
                        if (userResponse.isSuccess() || userResponse.isIntermediate()) {
                            ...
                            if (passResponse.isSuccess()) {
                                LOG.debug("FtpMonitor.poll: Login successful, parsed return code: {}",
                                          passResponse.getCode());
                                loggedInSuccessfully = true;
                            } else {
                                LOG.debug("FtpMonitor.poll: Login failed, parsed return code: {}, full response: {}",
                                          passResponse.getCode(), passResponse);
                    ...
                    if (loggedInSuccessfully) {
                         ...
                         */
                        if (quitResponse.isSuccess() || (quitResponse.getCode() == 530)
                                || (quitResponse.getCode() == 425)) {
