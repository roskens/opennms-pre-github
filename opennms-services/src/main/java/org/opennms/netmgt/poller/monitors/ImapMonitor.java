...
public final class ImapMonitor extends AbstractServiceMonitor {
     ...
     * '* OK , it indicates that we are talking to an IMAP server and we
     * continue. Next, a 'LOGOUT' command is sent to the interface. Again the
     * response is parsed and the response is verified to see that we get a '*
     * OK'. If the interface's response is valid we set the service status to
