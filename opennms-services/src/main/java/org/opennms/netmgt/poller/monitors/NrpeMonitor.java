...
public final class NrpeMonitor extends AbstractServiceMonitor {
    ...
    public PollStatus poll(MonitoredService svc, Map<String, Object> parameters) {
         ...
         * "NrpeMonitor: required parameter 'port' is not present in supplied properties."
         * );
         * }
         */
        ...
        for (tracker.reset(); tracker.shouldRetry() && serviceStatus != PollStatus.SERVICE_AVAILABLE; tracker.nextAttempt()) {
            ...
            try {
                ...
                if (response.getResultCode() == 0) {
                    ...
                    reason = "NRPE command returned code " + response.getResultCode() + " and message: "
                            + response.getBuffer();
                }
