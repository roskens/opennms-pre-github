...
/**
 * Manages Events trouble ticket related events and passes them to the service
 * layer
 * implementation.
 *
...
public class TroubleTicketer implements SpringServiceDaemon, EventListener {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        String[] ueis = { EventConstants.TROUBLETICKET_CANCEL_UEI, EventConstants.TROUBLETICKET_CLOSE_UEI,
                EventConstants.TROUBLETICKET_CREATE_UEI, EventConstants.TROUBLETICKET_UPDATE_UEI,
    ...
    /**
     * {@inheritDoc} Event listener Interface required implementation
     */
    @Override
    ...
    /**
     * Make call to API to Update a trouble ticket with new data from an
     * OnmsAlarm.
     *
     * @param e
     *            An OpenNMS Event
    ...
    /**
     * Make call to API to Create a new Trouble Ticket to be associated with an
     * OnmsAlarm.
     *
     * @param e
     *            An OpenNMS Event
    ...
    /**
     * Makes call to API to Cancel a Trouble Ticket associated with an
     * OnmsAlarm.
     *
     * @param e
     *            the e
        ...
        if (EventConstants.RELOAD_DAEMON_CONFIG_UEI.equals(event.getUei())) {
            ...
            for (Parm parm : parmCollection) {
                if (EventConstants.PARM_DAEMON_NAME.equals(parm.getParmName())
                        && "Ticketd".equalsIgnoreCase(parm.getValue().getContent())) {
                    isTarget = true;
                    break;
                }
            }
