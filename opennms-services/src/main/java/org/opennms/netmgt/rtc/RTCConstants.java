...
public final class RTCConstants {
     ...
     */
    public static final String DB_GET_INFO_FOR_IP = "SELECT  node.nodeid FROM "
     ...
     * nodeid/IP address.
     */
    public static final String DB_GET_SVC_ENTRIES = "SELECT service.servicename FROM ifServices, "
     ...
     */
    public static final String DB_GET_OUTAGE_ENTRIES = "SELECT ifLostService, ifRegainedService from outages,service "
