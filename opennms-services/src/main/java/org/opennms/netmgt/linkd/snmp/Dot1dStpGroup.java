...
public final class Dot1dStpGroup extends AggregateTracker {
     ...
     * protocol. IEEE 802.1d implementations will return 'ieee8021d(3)'. If
     * future versions of the IEEE Spanning Tree Protocol are released that are
     ...
     * .
     */
            // new NamedSnmpVar(NamedSnmpVar.SNMPTIMETICKS, STP_TIME_LASTTOPCH,
            // ".1.3.6.1.2.1.17.2.3"),
             ...
             * </P>
             */
            // new NamedSnmpVar(NamedSnmpVar.SNMPCOUNTER32, STP_TOP_CHANGES,
            // ".1.3.6.1.2.1.17.2.4"),
     ...
     * </P>
     */
    // new NamedSnmpVar(NamedSnmpVar.SNMPINT32, STP_MAX_AGE,
    // ".1.3.6.1.2.1.17.2.8"),
     ...
     * </P>
     */
    // new NamedSnmpVar(NamedSnmpVar.SNMPINT32, STP_HELLO_TIME,
    // ".1.3.6.1.2.1.17.2.9"),
     ...
     * </P>
     */
    // new NamedSnmpVar(NamedSnmpVar.SNMPINT32, STP_HOLD_TIME,
    // ".1.3.6.1.2.1.17.2.10"),
     ...
     * underway, to age all dynamic entries in the Forwarding Database. [Note
     * that this value is the one that this bridge is currently using, in
     ...
     * </P>
     */
    // new NamedSnmpVar(NamedSnmpVar.SNMPINT32, STP_FORW_DELAY,
    // ".1.3.6.1.2.1.17.2.11"),
     ...
     * agent may return a badValue error if a set is attempted to a value which
     * is not a whole number of seconds.
     * </P>
     */
    // new NamedSnmpVar(NamedSnmpVar.SNMPINT32, STP_BRDG_MAX_AGE,
    // ".1.3.6.1.2.1.17.2.12"),

    /**
     * <P>
     * The value that all bridges use for HelloTime when this bridge is acting
     * as the root. The granularity of this timer is specified by 802.1D- 1990
     ...
     * </P>
     */
    // new NamedSnmpVar(NamedSnmpVar.SNMPINT32, STP_BRDG_HELLO_TIME,
    // ".1.3.6.1.2.1.17.2.13"),

    /**
     * <P>
     * The value that all bridges use for ForwardDelay when this bridge is
     * acting as the root. Note that 802.1D-1990 specifies that the range for
     ...
     * </P>
     */
    // new NamedSnmpVar(NamedSnmpVar.SNMPINT32, STP_BRDG_FORW_DELAY,
    // ".1.3.6.1.2.1.17.2.14")
    };
