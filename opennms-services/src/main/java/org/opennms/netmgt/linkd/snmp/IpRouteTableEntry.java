...
/**
 * <P>
 * The IpRouteTableEntry class is designed to hold all the MIB-II information
 * for one entry in the ipRouteTable. The table effectively contains a list of
 * these entries, each entry having information about ip route. The entry
 * contains: ipRouteDest, ipRouteIfIndex, ipRouteMetric1, ipRouteMetric2,
 * ipRouteMetric3, ipRouteMetric4, ipRouteNextHop, ipRouteType, ipRouteProto,
 * ipRouteAge, ipRouteMask, ipRouteMetric5, ipRouteInfo.
 * </P>
 * <P>
 * This object is used by the IpRouteTable to hold infomation single entries in
 * the table. See the IpRouteTable documentation form more information.
 * </P>
 *
...
public final class IpRouteTableEntry extends IpRouteCollectorEntry {
     ...
     * Each of the elements in the list are an instance of the IpRoutetable.
     ...
     * </P>
     */
    public static final String TABLE_OID = ".1.3.6.1.2.1.4.21.1"; // start of
                                                                  // table
                                                                  // (GETNEXT)
