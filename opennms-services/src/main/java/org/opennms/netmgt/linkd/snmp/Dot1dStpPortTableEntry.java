...
/**
 * <P>
 * The Dot1dStpPortTableEntry class is designed to hold all the MIB-II
 * information for one entry in the MIB II
 * dot1dBridge.dot1dStp.dot1dStpPortTable. The table effectively contains a list
 * of these entries, each entry having information about STP Protocol on
 * specific Port.
 * </P>
 * <P>
 * This object is used by the Dot1dStpPortTable to hold information single
 * entries in the table. See the Dot1dStpPortTable documentation form more
 * information.
 * </P>
 *
...
public final class Dot1dStpPortTableEntry extends SnmpStore {
     ...
     * Each of the elements in the list are an instance of the StpPortTable.
     ...
     * Stp Port table in the MIB forest.
     * </P>
     */
    public static final String TABLE_OID = ".1.3.6.1.2.1.17.2.15.1"; // start of
                                                                     // table
                                                                     // (GETNEXT)
