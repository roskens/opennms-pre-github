...
/**
 * <P>
 * The Dot1dBaseTableEntry class is designed to hold all the MIB-II information
 * for one entry in the
 * .iso.org.dod.internet.mgmt.mib-2.dot1dBridge.dot1dBase.dot1dBasePortTable The
 * table effectively contains a list of these entries, each entry having
 * information about bridge info. The entry
 * dot1dBasePortTable.dot1dBasePortEntry contains:
 * </P>
 * <ul>
 * <li>dot1dBasePort</li>
 ...
 * </ul>
 * <P>
 * This object is used by the Dot1dBasePortTable to hold information single
 * entries in the table. See the Dot1dBasePortTable documentation form more
 * information.
 * </P>
 *
...
public final class Dot1dBasePortTableEntry extends SnmpStore {
     ...
     * Dot1dBridge.Dot1dBase table in the MIB forest.
     * </P>
     */
    public static final String TABLE_OID = ".1.3.6.1.2.1.17.1.4.1"; // start of
                                                                    // table
                                                                    // (GETNEXT)
