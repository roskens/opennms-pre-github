...
/**
 * <P>
 * The ExtremeNetworkVlanTableEntry class is designed to hold all the MIB-II
 ...
 * <P>
 * This object is used by the ExtremeNetworkVlanTable to hold information single
 * entries in the table. See the ExtremeNetworkVlanTable documentation form more
 * information.
 * </P>
 *
...
public final class ExtremeNetworkVlanTableEntry extends Vlan {
    ...
    public static NamedSnmpVar[] enVlan_elemList = new NamedSnmpVar[] {
            // new NamedSnmpVar(NamedSnmpVar.SNMPINT32, EXTREME_VLAN_IFINDEX,
            // ".1.3.6.1.4.1.1916.1.2.1.2.1.1", 1),
            ...
            // new NamedSnmpVar(NamedSnmpVar.SNMPINT32, EXTREME_VLAN_GLOBAL_ID,
            // ".1.3.6.1.4.1.1916.1.2.1.2.1.4", 4),
            new NamedSnmpVar(NamedSnmpVar.SNMPINT32, VLAN_STATUS, ".1.3.6.1.4.1.1916.1.2.1.2.1.6", 3),
            // new NamedSnmpVar(NamedSnmpVar.SNMPINT32,
            // EXTREME_VLAN_IGNORE_STP_FLAG, ".1.3.6.1.4.1.1916.1.2.1.2.1.7",
            // 6),
            // new NamedSnmpVar(NamedSnmpVar.SNMPINT32,
            // EXTREME_VLAN_IGNORE_BPDU_FLAG, ".1.3.6.1.4.1.1916.1.2.1.2.1.8",
            // 7),
            // new NamedSnmpVar(NamedSnmpVar.SNMPINT32,
            // EXTREME_VLAN_IFLOOP_MODE_FLAG, ".1.3.6.1.4.1.1916.1.2.1.2.1.9",
            // 8),
     ...
     * </P>
     */
    public static final String TABLE_OID = "        1.3.6.1.4.1.1916.1.2.1.2.1"; // start
                                                                                 // of
                                                                                 // table
                                                                                 // (GETNEXT)
