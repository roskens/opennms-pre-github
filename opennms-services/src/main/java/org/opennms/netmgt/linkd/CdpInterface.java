...
public class CdpInterface {
    ...
    /**
     * <p>
     * Getter for the field <code>cdpIfIndex</code>.
     * </p>
     *
    ...
    /**
     * <p>
     * Getter for the field <code>cdpTargetIfIndex</code>.
     * </p>
     *
    ...
    /**
     * <p>
     * Setter for the field <code>cdpTargetIfIndex</code>.
     * </p>
     *
     * @param ifindex
     *            a int.
    ...
    /**
     * <p>
     * Getter for the field <code>cdpTargetNodeId</code>.
     * </p>
     *
    ...
    /**
     * <p>
     * Setter for the field <code>cdpTargetNodeId</code>.
     * </p>
     *
     * @param cdpTargetNodeId
     *            The cdpTargetNodeId to set.
     */
    ...
    public String toString() {
        return new ToStringBuilder(this).append("ifindex", m_cdpIfIndex).append("targetNodeid", m_cdpTargetNodeId).append("cdptargetIfIndex:",
                                                                                                                          m_cdpTargetIfIndex).append("cdptargetDeviceId:",
                                                                                                                                                     m_cdpTargetDeviceId).toString();
    }
}
