 ...
 * contains a list of these entries, each entry having information about one
 * physical address. The entry contains the ifindex binding, the MAC address, ip
 * address and entry type.
 * </P>
 * <P>
 * This object is used by the IpNetToMediaTable to hold information single
 * entries in the table. See the IpNetToMediaTable documentation form more
 * information.
 * </P>
 *
...
public final class IpNetToMediaTableEntry extends SnmpStore {
     ...
     * </P>
     */
    public static final String TABLE_OID = ".1.3.6.1.2.1.4.22.1"; // start of
                                                                  // table
                                                                  // (GETNEXT)
     ...
     * IpNetToMediatable. Objects in this list should be used by multiple
    ...
    /**
     * <P>
     * Creates a default instance of the ipNetToMedia table entry map. The map
     * represents a singular instance of the mac address table. Each column in
     * the table for the loaded instance may be retrieved either through its
