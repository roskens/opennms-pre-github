...
/**
 * <P>
 * The Dot1dTpFdbTableEntry class is designed to hold all the MIB-II information
 * for one entry in the MIB II dot1dBridge.dot1dTp.dot1dTpFdbTable. The table
 * effectively contains a list of these entries, each entry having information
 * about bridge forwarding table.
 * </P>
 * <P>
 * This object is used by the Dot1dTpFdbTable to hold information single entries
 * in the table. See the Dot1dTpFdbTable documentation form more information.
 * </P>
 *
...
public final class Dot1dTpFdbTableEntry extends SnmpStore {
     ...
     * Each of the elements in the list are an instance of the Dot1dTpFbTable.
     ...
     * Bridge Forward table in the MIB forest.
     * </P>
     */
    public static final String TABLE_OID = ".1.3.6.1.2.1.17.4.3.1"; // start of
                                                                    // table
                                                                    // (GETNEXT)
