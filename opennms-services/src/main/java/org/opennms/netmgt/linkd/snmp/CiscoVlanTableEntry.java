...
/**
 * <P>
 * The CiscoVlanTableEntry class is designed to hold all the information for one
 * entry in the:
 * iso.org.dod.internet.private.enterprises.cisco.ciscoMgmt.ciscoVtpMIB
 * .vtpMIBObjects.vlanInfo.vtpVlanTable
 * </P>
 * <P>
 * This object is used by the CiscoVlanTable to hold information single entries
 * in the table. See the CiscoVlanPortTable documentation form more information.
 * </P>
 *
...
public final class CiscoVlanTableEntry extends Vlan {
     ...
     * </P>
     */
    public static final String TABLE_OID = ".1.3.6.1.4.1.9.9.46.1.3.1.1"; // start
                                                                          // of
                                                                          // table
                                                                          // (GETNEXT)
    ...
    // new NamedSnmpVar(NamedSnmpVar.SNMPINT32, CISCOVTP_VLAN_MTU, TABLE_OID +
    // ".5", 5),
    // new NamedSnmpVar(NamedSnmpVar.SNMPOCTETSTRING, CISCOVTP_VLAN_D10S,
    // TABLE_OID + ".6", 6),
    // new NamedSnmpVar(NamedSnmpVar.SNMPINT32, CISCOVTP_VLAN_RINGN, TABLE_OID +
    // ".7", 7),
    // new NamedSnmpVar(NamedSnmpVar.SNMPINT32, CISCOVTP_VLAN_BRIDGEN, TABLE_OID
    // + ".8", 8),
    // new NamedSnmpVar(NamedSnmpVar.SNMPINT32, CISCOVTP_VLAN_STPTYPE, TABLE_OID
    // + ".9", 9),
    // new NamedSnmpVar(NamedSnmpVar.SNMPINT32, CISCOVTP_VLAN_PARV, TABLE_OID +
    // ".10", 10),
    // new NamedSnmpVar(NamedSnmpVar.SNMPINT32, CISCOVTP_VLAN_TRV1, TABLE_OID +
    // ".11", 11),
    // new NamedSnmpVar(NamedSnmpVar.SNMPINT32, CISCOVTP_VLAN_TRV2, TABLE_OID +
    // ".12", 12),
    // new NamedSnmpVar(NamedSnmpVar.SNMPINT32, CISCOVTP_VLAN_BRIDGETYPE,
    // TABLE_OID + ".13", 13),
    // new NamedSnmpVar(NamedSnmpVar.SNMPINT32, CISCOVTP_VLAN_AREHC, TABLE_OID +
    // ".14", 14),
    // new NamedSnmpVar(NamedSnmpVar.SNMPINT32, CISCOVTP_VLAN_STEHC, TABLE_OID +
    // ".15", 15),
    // new NamedSnmpVar(NamedSnmpVar.SNMPINT32, CISCOVTP_VLAN_ISCRFBACHUP,
    // TABLE_OID + ".16", 16),
    // new NamedSnmpVar(NamedSnmpVar.SNMPINT32, CISCOVTP_VLAN_TYPEEXT, TABLE_OID
    // + ".17", 17),
    // new NamedSnmpVar(NamedSnmpVar.SNMPINT32, CISCOVTP_VLAN_IFINDEX, TABLE_OID
    // + ".18", 18)
    };
