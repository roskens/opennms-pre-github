...
/**
 * <p>
 * The {@link IpCidrRouteTableEntry} class is designed to hold all the MIB-II
 ...
 * single entries in the table. See {@link InetCidrRouteTable} for more
 * information.
 * </p>
 *
...
public final class IpCidrRouteTableEntry extends IpRouteCollectorEntry {
     ...
     * </P>
     */
    public static final String TABLE_OID = ".1.3.6.1.2.1.4.24.4.1"; // start of
                                                                    // table
                                                                    // (GETNEXT)
     ...
     * Each of the elements in the list are an instance of the IpCidrRoutetable.
