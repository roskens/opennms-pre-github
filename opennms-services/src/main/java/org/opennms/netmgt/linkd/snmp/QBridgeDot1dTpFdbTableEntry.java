 ...
 * The table effectively contains a list of these entries, each entry having
 * information about bridge forwarding table.
 * </P>
 * <P>
...
public final class QBridgeDot1dTpFdbTableEntry extends SnmpStore {
     ...
     * </P>
     */
    public static final String TABLE_OID = ".1.3.6.1.2.1.17.7.1.2.2"; // start
                                                                      // of
                                                                      // table
                                                                      // (GETNEXT)
