...
/**
 * <p>
 * The {@link InetCidrRouteTableEntry} class is designed to hold all the MIB-II
 * information for one entry in the ipRouteTable. The table effectively contains
 * a list of these entries, each entry having information about IP route. The
 * entry contains:
 * </p>
 * <ul>
 * <li>ipRouteDest</li>
...
public final class InetCidrRouteTableEntry extends IpRouteCollectorEntry {
     ...
     * Each of the elements in the list are an instance of the
     * InetCidrRoutetable. Objects in this list should be used by multiple
     ...
     */
            //
            // AlanE : There is no ROUTE_MASK in ipV6 (inetCidr) instead we
            // should use Prefix length
            // I've changed the getRouteMask function to convert the /prefix
            // into a netmask
            //
     ...
     */
    //
    // AlanE: It doesn't look like there is an equivalent of ipRouteInfo in the
    // inetCidr table
    // Just comment out for now
    //
    // new NamedSnmpVar(NamedSnmpVar.SNMPOBJECTID, IP_ROUTE_INFO,
    // ".1.3.6.1.2.1.4.24.7.1.9", 13)
    };

    /**
     * <P>
     * The TABLE_OID is the object identifier that represents the root of the IP
     * ROUTE table in the MIB forest.
     * </P>
     */
    public static final String TABLE_OID = ".1.3.6.1.2.1.4.24.7.1"; // start of
                                                                    // table
                                                                    // (GETNEXT)

    /**
     * <P>
     * Creates a default instance of the ipROUTE table entry map. The map
     * represents a singular instance of the routing table. Each column in the
     * table for the loaded instance may be retrieved either through its name or
     * object identifier.
     * </P>
     * <P>
