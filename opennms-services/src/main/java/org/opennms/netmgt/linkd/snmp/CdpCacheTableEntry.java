...
/**
 * <P>
 * The CdpCacheTableEntry class is designed to hold all the MIB-II information
 ...
 * </P>
 * <P>
 * This object is used by the CdpCacheTable to hold information single entries
 * in the table. See the CdpCacheTable documentation form more information.
 * </P>
 *
...
public final class CdpCacheTableEntry extends SnmpStore {
    ...
    /**
     * <P>
     * The (first) network-layer address of the device's SNMP-agent as reported
     * in the Address TLV of the most recently received CDP message. For
     * example, if the corresponding instance of cacheAddressType had the value
     ...
     * message. The zero-length string indicates that no Platform field (TLV)
     * was reported in the most recent CDP message.
     * </P>
     */
    // new NamedSnmpVar(NamedSnmpVar.SNMPOCTETSTRING, CDP_PLATFORM,
    // ".1.3.6.1.4.1.9.9.23.1.2.1.1.8", 8),
     ...
     * </P>
     */
    // new NamedSnmpVar(NamedSnmpVar.SNMPOCTETSTRING, CDP_CAPS,
    // ".1.3.6.1.4.1.9.9.23.1.2.1.1.9", 9),

    /**
     * <P>
     * The VTP Management Domain for the remote device's interface, as reported
     * in the most recently received CDP message. This object is not
     * instantiated if no VTP Management Domain field (TLV) was reported in the
     * most recently received CDP message.
     * </P>
     */
    // new NamedSnmpVar(NamedSnmpVar.SNMPOCTETSTRING, CDP_VTP_MGMTDOMAIN,
    // ".1.3.6.1.4.1.9.9.23.1.2.1.1.10", 10),
     ...
     * </P>
     */
    // new NamedSnmpVar(NamedSnmpVar.SNMPINT32, CDP_NATIVEVLAN,
    // ".1.3.6.1.4.1.9.9.23.1.2.1.1.11", 11),
     ...
     * </P>
     */
    // new NamedSnmpVar(NamedSnmpVar.SNMPINT32, CDP_DUPLEX,
    // ".1.3.6.1.4.1.9.9.23.1.2.1.1.12", 12),
     ...
     * </P>
     */
    // new NamedSnmpVar(NamedSnmpVar.SNMPGAUGE32, CDP_APPLIANCEID,
    // ".1.3.6.1.4.1.9.9.23.1.2.1.1.13", 13),
     ...
     * </P>
     */
    // new NamedSnmpVar(NamedSnmpVar.SNMPGAUGE32, CDP_VLANID,
    // ".1.3.6.1.4.1.9.9.23.1.2.1.1.14", 14),

    /**
     * <P>
     * The amount of power consumed by remote device, as reported in the most
     * recent CDP message. This object is not instantiated if no Power
     * Consumption field (TLV) was reported in the most recently received CDP
     * message.
     * </P>
     */
    // new NamedSnmpVar(NamedSnmpVar.SNMPGAUGE32, CDP_POWERCONS,
    // ".1.3.6.1.4.1.9.9.23.1.2.1.1.15", 15),
     ...
     */
    // new NamedSnmpVar(NamedSnmpVar.SNMPGAUGE32, CDP_POWERCONS,
    // ".1.3.6.1.4.1.9.9.23.1.2.1.1.16", 16),

    /**
     * <P>
     * Indicates the value of the remote device's sysName MIB object. By
     * convention, it is the device's fully qualified domain name. This object
     * is not instantiated if no sysName field (TLV) was reported in the most
     * recently received CDP message.
     * </P>
     */
    // new NamedSnmpVar(NamedSnmpVar.SNMPOCTETSTRING, CDP_SYSNAME,
    // ".1.3.6.1.4.1.9.9.23.1.2.1.1.17", 17),
     ...
     * the most recently received CDP message.
     * </P>
     */
    // new NamedSnmpVar(NamedSnmpVar.SNMPOBJECTID, CDP_SYSOBJID,
    // ".1.3.6.1.4.1.9.9.23.1.2.1.1.18", 18),

    /**
     * <P>
     * An indication of the type of address contained in the corresponding
     * instance of cdpCachePrimaryMgmtAddress.
     * </P>
     */
    // new NamedSnmpVar(NamedSnmpVar.SNMPINT32, CDP_PRIMARYMGMTADDR_TYPE,
    // ".1.3.6.1.4.1.9.9.23.1.2.1.1.19", 19),

    /**
     * <P>
     * This object indicates the (first) network layer address at which the
     * device will accept SNMP messages as reported in the most recently
     * received CDP message. If the corresponding instance of
     * cdpCachePrimaryMgmtAddrType has the value 'ip(1)', then this object would
     * be an IP-address. If the remote device is not currently manageable via
     * any network protocol, this object has the special value of the IPv4
     * address 0.0.0.0. If the most recently received CDP message did not
     * contain any primary address at which the device prefers to receive SNMP
     * messages, then this object is not instanstiated.
     * </P>
     */
    // new NamedSnmpVar(NamedSnmpVar.SNMPOCTETSTRING, CDP_PRIMARYMGMTADDR,
    // ".1.3.6.1.4.1.9.9.23.1.2.1.1.20", 20),

    /**
     * <P>
     * An indication of the type of address contained in the corresponding
     * instance of cdpCacheSecondryMgmtAddress.
     * </P>
     */
    // new NamedSnmpVar(NamedSnmpVar.SNMPINT32, CDP_SECONDARYMGMTADDR_TYPE,
    // ".1.3.6.1.4.1.9.9.23.1.2.1.1.21", 21),

    /**
     * <P>
     * This object indicates the alternate network layer address (other than the
     * one indicated by cdpCachePrimaryMgmtAddr) at which the device will accept
     * SNMP messages as reported in the most recently received CDP message. If
     * the corresponding instance of cdpCacheSecondaryMgmtAddrType has the value
     * 'ip(1)', then this object would be an IP-address. If the most recently
     * received CDP message did not contain such an alternate network layer
     * address, then this object is not instanstiated.
     * </P>
     */
    // new NamedSnmpVar(NamedSnmpVar.SNMPOCTETSTRING, CDP_SECONDARYMGMTADDR,
    // ".1.3.6.1.4.1.9.9.23.1.2.1.1.22", 22),

    /**
     * <P>
     * Indicates the physical location, as reported by the most recent CDP
     * message, of a connector which is on, or physically connected to, the
     * remote device's interface over which the CDP packet is sent. This object
     * is not instantiated if no Physical Location field (TLV) was reported by
     * the most recently received CDP message.
     * </P>
     */
    // new NamedSnmpVar(NamedSnmpVar.SNMPOCTETSTRING, CDP_PHYSLOC,
    // ".1.3.6.1.4.1.9.9.23.1.2.1.1.23", 23),

    /**
     * <P>
     * Indicates the time when this cache entry was last changed. This object is
     * initialised to the current time when the entry gets created and updated
     * to the current time whenever the value of any (other) object instance in
     * the corresponding row is modified.
     * </P>
     */
    // new NamedSnmpVar(NamedSnmpVar.SNMPTIMETICKS, CDP_LASTCHANGE,
    // ".1.3.6.1.4.1.9.9.23.1.2.1.1.24", 24)
    };

    /**
     * <P>
     * The TABLE_OID is the object identifier that represents the root of the
     * table CdPCacheTable in the MIB forest.
     * </P>
     */
    public static final String TABLE_OID = ".1.3.6.1.4.1.9.9.23.1.2.1.1"; // start
                                                                          // of
                                                                          // table
                                                                          // (GETNEXT)
    ...
    /**
     * Gets the cdp cache ipv4 address.
     *
     * @return the cdp cache ipv4 address
     */
