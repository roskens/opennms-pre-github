...
public class SnmpCollectorTest implements InitializingBean, TestContextAware {
    ...
    public void testPersist() throws Exception {
        ...
        assertEquals(Double.valueOf(123.0), RrdUtils.fetchLastValueInRange(rrdFile.getParent(), rrdFile.getName(), "tcpCurrEstab", stepSizeInMillis, stepSizeInMillis));

        // This is the value from snmpTestData1.properties
        // .1.3.6.1.2.1.2.2.1.10.6 = Counter32: 1234567
        assertEquals(Double.valueOf(1234567.0), RrdUtils.fetchLastValueInRange(ifRrdFile.getParent(), ifRrdFile.getName(), "ifInOctets", stepSizeInMillis, stepSizeInMillis));
        ...
        assertEquals(Double.valueOf(456.0), RrdUtils.fetchLastValueInRange(rrdFile.getParent(), rrdFile.getName(), "tcpCurrEstab", stepSizeInMillis, stepSizeInMillis));
        assertEquals(Double.valueOf(7654321.0), RrdUtils.fetchLastValueInRange(ifRrdFile.getParent(), ifRrdFile.getName(), "ifInOctets", stepSizeInMillis, stepSizeInMillis));
    ...
    public void testUsingFetch() throws Exception {
        ...
        assertEquals(Double.valueOf(1.0), m_rrdStrategy.fetchLastValueInRange(rrdFile.getParent(), rrdFile.getName(), "testAttr", stepSize * 1000, 2 * stepSize * 1000));
    }
