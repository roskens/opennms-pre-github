 ...
 * properly (which we kind of assume
 * to be the case anyway).
 * Therefore on one hand, they are "belt-and-britches" security (affirming that
 * JEP works). On the other
 * we also still need to test that our integration with JEP works as expected
 * (e.g., that there are no oddities
...
public class ThresholdExpressionTestCase extends TestCase {
    ...
    /**
     * Test evaluate evaluate single item with division.
     *
     * @throws Exception
     *             the exception
     */
    ...
    /**
     * Test evaluate evaluate single item with multiply.
     *
     * @throws Exception
     *             the exception
     */
    ...
    /**
     * Test evaluate evaluate single item with subtraction.
     *
     * @throws Exception
     *             the exception
     */
    ...
    /**
     * Test evaluate evaluate single item with addition.
     *
     * @throws Exception
     *             the exception
     */
    ...
    /**
     * Test evaluate evaluate multiple items divided.
     *
     * @throws Exception
     *             the exception
     */
    ...
    /**
     * Test evaluate evaluate multiple items multiplied.
     *
     * @throws Exception
     *             the exception
     */
    ...
    /**
     * Test evaluate evaluate multiple items added.
     *
     * @throws Exception
     *             the exception
     */
    ...
    /**
     * Test evaluate evaluate multiple items subtracted.
     *
     * @throws Exception
     *             the exception
     */
    ...
    /*
     * Modelled on an expression that could be required for hrStorageIndex,
     * where
     * we want to threshold not on percentage full (which we get from
     * "Used/Size"), but rather
     * when free space is lower than some number of bytes (KB, MB, GB, TB,
     * whatever)
     */
    /**
     * Test semi complex expression.
     *
     * @throws Exception
     *             the exception
     */
    ...
    public void testThresholdEntityRequiredDataSources() throws Exception {
        ...
        assertTrue("Required data sources should contain hrStorageSize: " + dsString,
                   dataSources.contains("hrStorageSize"));
        assertTrue("Required data sources should contain hrStorageUsed: " + dsString,
                   dataSources.contains("hrStorageUsed"));
        assertTrue("Required data sources should contain hrStorageAllocationUnits: " + dsString,
                   dataSources.contains("hrStorageAllocationUnits"));
    }

    /**
     * Test evaluate conditional false.
     *
     * @throws Exception
     *             the exception
     */
    public void testEvaluateConditionalFalse() throws Exception {
        // Doesn't work because the expression is actually being evaluated to
        // sniff
    ...
    /**
     * Test evaluate conditional true.
     *
     * @throws Exception
     *             the exception
     */
