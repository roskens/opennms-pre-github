...
public class CollectionResourceWrapperTest {
    ...
    private SnmpCollectionAgent createCollectionAgent() {
        ...
        EasyMock.expect(agent.getStorageDir()).andReturn(Paths.get(ResourceTypeUtils.FOREIGN_SOURCE_DIRECTORY, "JUnit", "T001")).anyTimes();
    ...
    private RrdRepository getRepository() {
        ...
        repo.setRrdBaseDir(Paths.get("/tmp"));
        return repo;
    }
