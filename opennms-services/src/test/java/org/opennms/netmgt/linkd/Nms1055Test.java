...
public class Nms1055Test extends Nms1055NetworkBuilder implements InitializingBean {
    ...
    public void testAbstractQueryManagerforLldp() {
         ...
         */
        assertEquals(13,
                     queryManager.getFromSysnameIpAddress(DELAWARE_NAME, InetAddressUtils.addr("10.155.69.17")).intValue());
     ...
     * Penrose: stpport/designatedbridge/designatedport 62/8000
     * 001f12373dc0/8201
     * -----To Riovista - Root Spanning tree: ifindex 515 ---ge-1/2/1
     * Penrose: stpport/designatedbridge/designatedport 483/8000
     * 0022830957d0/81e3
     ...
     * Delaware: stpport/designatedbridge/designatedport 21/8000
     * 001f12373dc0/822f
     * -----To Riovista - Root Spanning tree: ifindex 540 -- ge-0/2/0
     * Delaware: stpport/designatedbridge/designatedport 483/8000
     * 0022830957d0/81e3
     ...
     * Riovista: stpport/designatedbridge/designatedport 513/8000
     * 001f12373dc0/8201
     * -----To Penrose ifindex 584 ---ge-0/0/0.0
     * Riovista: stpport/designatedbridge/designatedport
     * 559/8000001f12373dc0/822f
     ...
     * one on ae0 using stp and another over xe-1/0/0.0 using the ip route next
     * hop strategy
     ...
     * This test passes because i've verified that this is what the linkd can
     * discover using it's values
