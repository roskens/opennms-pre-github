...
/**
 * The Class Nms10205aNetworkBuilder.
 *
...
public abstract class Nms10205aNetworkBuilder extends LinkdNetworkBuilder {
    ...
    static {
        ...
        CHENNAI_IP_IF_MAP.put(InetAddressUtils.addr("192.168.5.6"), 528);
        CHENNAI_IP_IF_MAP.put(InetAddressUtils.addr("128.0.0.4"), 18);
        CHENNAI_IP_IF_MAP.put(InetAddressUtils.addr("192.168.6.1"), 16);
        CHENNAI_IP_IF_MAP.put(InetAddressUtils.addr("10.205.56.6"), 523);
        CHENNAI_IP_IF_MAP.put(InetAddressUtils.addr("192.168.1.18"), 517);
        CHENNAI_IP_IF_MAP.put(InetAddressUtils.addr("172.16.6.1"), 533);
        CHENNAI_IP_IF_MAP.put(InetAddressUtils.addr("128.0.0.1"), 18);
        CHENNAI_IP_IF_MAP.put(InetAddressUtils.addr("10.0.0.4"), 18);
        CHENNAI_IP_IF_MAP.put(InetAddressUtils.addr("192.168.1.1"), 532);
        ...
        CHENNAI_IF_NETMASK_MAP.put(528, InetAddressUtils.addr("255.255.255.252"));
        ...
        CHENNAI_IF_IFALIAS_MAP.put(521, "TO-J1");
        ...
        CHENNAI_IF_IFALIAS_MAP.put(516, "TO-MYSORE");
        ...
        CHENNAI_IF_IFALIAS_MAP.put(520, "TO-DELHI");
        ...
        CHENNAI_IF_NETMASK_MAP.put(533, InetAddressUtils.addr("255.255.255.252"));
        ...
        CHENNAI_IF_IFALIAS_MAP.put(518, "TO-QAINDIA");
        ...
        CHENNAI_IF_NETMASK_MAP.put(16, InetAddressUtils.addr("255.255.255.255"));
        ...
        CHENNAI_IF_NETMASK_MAP.put(517, InetAddressUtils.addr("255.255.255.252"));
        ...
        CHENNAI_IF_NETMASK_MAP.put(532, InetAddressUtils.addr("255.255.255.252"));
        ...
        CHENNAI_IF_NETMASK_MAP.put(18, InetAddressUtils.addr("255.0.0.0"));
        ...
        CHENNAI_IF_NETMASK_MAP.put(523, InetAddressUtils.addr("255.255.0.0"));
        ...
        CHENNAI_IF_IFALIAS_MAP.put(540, "TO-BAGMANE");
        ...
        CHENNAI_IF_IFALIAS_MAP.put(519, "TO-MUMBAI");
        ...
        J6350_41_IP_IF_MAP.put(InetAddressUtils.addr("10.0.0.16"), 22);
        J6350_41_IP_IF_MAP.put(InetAddressUtils.addr("10.205.56.41"), 508);
        J6350_41_IP_IF_MAP.put(InetAddressUtils.addr("128.0.0.1"), 22);
        J6350_41_IP_IF_MAP.put(InetAddressUtils.addr("10.0.0.1"), 22);
        J6350_41_IP_IF_MAP.put(InetAddressUtils.addr("172.16.6.2"), 517);
        J6350_41_IP_IF_MAP.put(InetAddressUtils.addr("128.0.1.16"), 22);
        J6350_41_IF_IFNAME_MAP.put(512, "ip-0/0/0");
        J6350_41_IF_IFDESCR_MAP.put(512, "ip-0/0/0");
        J6350_41_IF_IFNAME_MAP.put(7, "tap");
        J6350_41_IF_IFDESCR_MAP.put(7, "tap");
        J6350_41_IF_IFNAME_MAP.put(11, "pimd");
        J6350_41_IF_IFDESCR_MAP.put(11, "pimd");
        J6350_41_IF_IFNAME_MAP.put(505, "ppe0");
        J6350_41_IF_IFDESCR_MAP.put(505, "ppe0");
        J6350_41_IF_IFNAME_MAP.put(501, "lo0.32768");
        J6350_41_IF_IFDESCR_MAP.put(501, "lo0.32768");
        J6350_41_IF_IFNAME_MAP.put(516, "lt-0/0/0");
        J6350_41_IF_IFDESCR_MAP.put(516, "lt-0/0/0");
        J6350_41_IF_MAC_MAP.put(516, "2c6bf55ee100");
        J6350_41_IF_IFNAME_MAP.put(515, "mt-0/0/0");
        J6350_41_IF_IFDESCR_MAP.put(515, "mt-0/0/0");
        J6350_41_IF_IFNAME_MAP.put(22, "lo0.16385");
        J6350_41_IF_IFDESCR_MAP.put(22, "lo0.16385");
        J6350_41_IF_NETMASK_MAP.put(22, InetAddressUtils.addr("255.255.255.255"));
        J6350_41_IF_IFNAME_MAP.put(4, "lsi");
        J6350_41_IF_IFDESCR_MAP.put(4, "lsi");
        J6350_41_IF_IFNAME_MAP.put(508, "ge-0/0/0.0");
        J6350_41_IF_IFDESCR_MAP.put(508, "ge-0/0/0.0");
        J6350_41_IF_MAC_MAP.put(508, "2c6bf55ee100");
        J6350_41_IF_NETMASK_MAP.put(508, InetAddressUtils.addr("255.255.0.0"));
        J6350_41_IF_IFNAME_MAP.put(513, "gr-0/0/0");
        J6350_41_IF_IFDESCR_MAP.put(513, "gr-0/0/0");
        J6350_41_IF_IFNAME_MAP.put(12, "mtun");
        J6350_41_IF_IFDESCR_MAP.put(12, "mtun");
        J6350_41_IF_IFNAME_MAP.put(5, "dsc");
        J6350_41_IF_IFDESCR_MAP.put(5, "dsc");
        J6350_41_IF_IFNAME_MAP.put(506, "vlan");
        J6350_41_IF_IFDESCR_MAP.put(506, "vlan");
        J6350_41_IF_MAC_MAP.put(506, "2c6bf55ee108");
        J6350_41_IF_IFNAME_MAP.put(510, "ge-0/0/2");
        J6350_41_IF_IFDESCR_MAP.put(510, "ge-0/0/2");
        J6350_41_IF_MAC_MAP.put(510, "2c6bf55ee102");
        J6350_41_IF_IFNAME_MAP.put(504, "ppd0");
        J6350_41_IF_IFDESCR_MAP.put(504, "ppd0");
        J6350_41_IF_IFNAME_MAP.put(502, "pp0");
        J6350_41_IF_IFDESCR_MAP.put(502, "pp0");
        J6350_41_IF_IFNAME_MAP.put(6, "lo0");
        J6350_41_IF_IFDESCR_MAP.put(6, "lo0");
        J6350_41_IF_IFNAME_MAP.put(509, "ge-0/0/1");
        J6350_41_IF_IFDESCR_MAP.put(509, "ge-0/0/1");
        J6350_41_IF_MAC_MAP.put(509, "2c6bf55ee101");
        J6350_41_IF_IFNAME_MAP.put(10, "pime");
        J6350_41_IF_IFDESCR_MAP.put(10, "pime");
        J6350_41_IF_IFNAME_MAP.put(8, "gre");
        J6350_41_IF_IFDESCR_MAP.put(8, "gre");
        J6350_41_IF_IFNAME_MAP.put(507, "ge-0/0/0");
        J6350_41_IF_IFDESCR_MAP.put(507, "ge-0/0/0");
        J6350_41_IF_MAC_MAP.put(507, "2c6bf55ee100");
        J6350_41_IF_IFNAME_MAP.put(511, "ge-0/0/3");
        J6350_41_IF_IFDESCR_MAP.put(511, "ge-0/0/3");
        J6350_41_IF_MAC_MAP.put(511, "2c6bf55ee103");
        J6350_41_IF_IFNAME_MAP.put(9, "ipip");
        J6350_41_IF_IFDESCR_MAP.put(9, "ipip");
        J6350_41_IF_IFNAME_MAP.put(514, "lsq-0/0/0");
        J6350_41_IF_IFDESCR_MAP.put(514, "lsq-0/0/0");
        J6350_41_IF_IFNAME_MAP.put(517, "ge-0/0/1.0");
        J6350_41_IF_IFDESCR_MAP.put(517, "ge-0/0/1.0");
        J6350_41_IF_MAC_MAP.put(517, "2c6bf55ee101");
        J6350_41_IF_NETMASK_MAP.put(517, InetAddressUtils.addr("255.255.255.252"));
        J6350_41_IF_IFNAME_MAP.put(503, "st0");
        J6350_41_IF_IFDESCR_MAP.put(503, "st0");
        ...
        SSG550_IP_IF_MAP.put(InetAddressUtils.addr("192.169.1.99"), 2);
        SSG550_IP_IF_MAP.put(InetAddressUtils.addr("2.2.2.1"), 4);
        SSG550_IP_IF_MAP.put(InetAddressUtils.addr("10.205.35.100"), 1);
        SSG550_IP_IF_MAP.put(InetAddressUtils.addr("10.1.1.99"), 3);
        SSG550_IF_IFNAME_MAP.put(1, "ethernet0/0");
        SSG550_IF_IFDESCR_MAP.put(1, "ethernet0/0");
        SSG550_IF_MAC_MAP.put(1, "00121ead3f00");
        SSG550_IF_NETMASK_MAP.put(1, InetAddressUtils.addr("255.255.0.0"));
        SSG550_IF_IFNAME_MAP.put(3, "ethernet0/2");
        SSG550_IF_IFDESCR_MAP.put(3, "ethernet0/2");
        SSG550_IF_MAC_MAP.put(3, "00121ead3f06");
        SSG550_IF_NETMASK_MAP.put(3, InetAddressUtils.addr("255.255.255.0"));
        SSG550_IF_IFNAME_MAP.put(2, "ethernet0/1");
        SSG550_IF_IFDESCR_MAP.put(2, "ethernet0/1");
        SSG550_IF_MAC_MAP.put(2, "00121ead3f05");
        SSG550_IF_NETMASK_MAP.put(2, InetAddressUtils.addr("255.255.255.0"));
        SSG550_IF_IFNAME_MAP.put(5, "vlan1");
        SSG550_IF_IFDESCR_MAP.put(5, "vlan1");
        SSG550_IF_MAC_MAP.put(5, "00121ead3f0f");
        SSG550_IF_IFNAME_MAP.put(4, "ethernet0/3");
        SSG550_IF_IFDESCR_MAP.put(4, "ethernet0/3");
        SSG550_IF_MAC_MAP.put(4, "00121ead3f07");
    ...
    /**
     * Gets the space ex sw1.
     *
     * @return the space ex sw1
     */
    ...
    /**
     * Gets the space ex sw2.
     *
     * @return the space ex sw2
     */
