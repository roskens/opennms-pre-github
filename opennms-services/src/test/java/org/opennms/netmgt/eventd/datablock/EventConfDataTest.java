...
public class EventConfDataTest {
    ...
    public void setUp() throws Exception {
        ...
        eventConfDao.setConfigResource(new FileSystemResource(
                                                              ConfigurationTestUtils.getFileForResource(this,
                                                                                                        "eventconf.xml")));
    ...
    /*
     * public void testV2EnterpriseIdAndGenericAndSpecificMatchWithZero() throws
     * Exception {
    ...
    public void testV1EnterpriseIdAndGenericAndSpecificAndMatchWithVarbindsAndTC() throws Exception {
         ...
         * SNMP Textual Convention applied to correctly turn the octects from
         * the
         * varbind into a display string formatted as a macaddress of the form
         * xx:xx:xx:xx:xx:xx per the DISPLAY-HINT in the mib. There are two
         * problems
         ...
         * info.
         * 2. The DISPLAY-HINT information that is encoded in the event conf
         * file is
         * lost due to the data and code structures of the matching code in
         * EventConfData.getEvent() this needs to be enhanced to use a 'wrapped'
         * object
        ...
        anticipateAndSend("uei.opennms.org/vendor/cisco/bsnAPNoiseProfileUpdatedToPass", "v1",
    ...
    public void anticipateAndSend(String event, Event snmp) {
        ...
        if (event != null) {
            ...
            if (econf != null) {
                ...
                if (complain) {
                    fail("Was not expecting an eventconf, but received an eventconf with " + "an UEI of \""
                            + econf.getUei() + "\"");
                }
            }
            // everything's fine
