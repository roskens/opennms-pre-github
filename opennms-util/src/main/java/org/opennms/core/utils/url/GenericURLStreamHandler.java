 ...
 * </p>
 * <p/>
 * Customized URL stream handler creates dynamically created URL connections
 * from customized URL protocols.
 *
...
public class GenericURLStreamHandler extends URLStreamHandler {
     ...
     *
     * @param urlConnectionClass
     *            full qualified classname as            {@java.lang.String
     * } object.
     * @param defaultPort
     *            default port as {@java.lang.int} object.
     */
    ...
    protected URLConnection openConnection(URL u) throws IOException {
        ...
        try {
            Constructor<? extends URLConnection> constructor = urlConnectionClass.getConstructor(new Class[] { URL.class });
            urlConnection = (URLConnection) constructor.newInstance(new Object[] { u });
