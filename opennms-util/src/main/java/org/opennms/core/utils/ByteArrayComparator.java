...
/**
 * Comparator that is used to compare byte arrays. This should be used to
 * compare
 * IP addresses using {@link java.net.InetAddress#getAddress()} and can be used
 * to
    ...
    public int compare(byte[] a, byte[] b) {
        if (a == null && b == null) {
            ...
            if (comparison != 0) {
                ...
                // OK both arrays are the same length and every byte is
                // identical so they are equal
                return 0;
            }
        }
    }
