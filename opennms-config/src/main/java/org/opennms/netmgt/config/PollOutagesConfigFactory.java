...
public final class PollOutagesConfigFactory extends PollOutagesConfigManager {
     ...
     */
    PollOutagesConfigFactory(final Path configFile) {
        setConfigResource(new FileSystemResource(configFile.toFile()));
    }
    ...
    public static synchronized void init() throws IOException, MarshalException, ValidationException {
        ...
        m_singleton = new PollOutagesConfigFactory(ConfigFileConstants.getFile(ConfigFileConstants.POLL_OUTAGES_CONFIG_FILE_NAME));
    ...
    protected void saveXML(final String xmlString) throws IOException, MarshalException, ValidationException {
        ...
        Path cfgFile = ConfigFileConstants.getFile(ConfigFileConstants.POLL_OUTAGES_CONFIG_FILE_NAME);
