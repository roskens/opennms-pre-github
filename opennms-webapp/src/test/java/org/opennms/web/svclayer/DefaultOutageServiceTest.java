...
public class DefaultOutageServiceTest {
    ...
    public void testLoadOneOutage() {
        ...
        verify(outageDao);
        assertTrue("Yay we can load a single outage... ", outage.equals(outage2));
    ...
    public void testGetCurrentOutageCount() {
        ...
        verify(outageDao);
        assertTrue("A good system should have outages ", count.equals(Integer.valueOf(1)));
    ...
    public void testSuppressedByRange() {
        ...
        // replay(outageDao);
        //
        // Set suppressed = (Set) outageService.getSuppressedOutagesByRange(1,
        // 1);
        // verify(outageDao);
        // assertTrue("Current Outages", suppressed.equals(expectedOutages));
