...
public class SnmpConfigRestServiceTest extends AbstractSpringJerseyRestTestCase {
    ...
    private Path m_snmpConfigFile;

	@Override
	protected void beforeServletStart() throws Exception {
        Path dir = Paths.get("target", "test-work-dir");
	...
	private void setSnmpConfigFile(final String snmpConfigContent) throws IOException {
        m_snmpConfigFile = Files.createTempFile("snmp-config-", ".xml");
        m_snmpConfigFile.toFile().deleteOnExit();
        Files.write(m_snmpConfigFile, snmpConfigContent.getBytes());
        SnmpPeerFactory.setPath(m_snmpConfigFile);
	...
	private void dumpConfig() throws Exception {
        IOUtils.copy(Files.newBufferedReader(m_snmpConfigFile, Charset.defaultCharset()), System.out);
	}
