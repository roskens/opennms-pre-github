...
public class UserRestServiceTest extends AbstractSpringJerseyRestTestCase {
    ...
    protected void createUser(final String username) throws Exception {
        String user = "<user>" + "<user-id>" + username + "</user-id>" + "<full-name>" + username
                + " Full Name</full-name>" + "<user-comments>Autogenerated by a unit test...</user-comments>"
                + "<password>21232F297A57A5A743894A0E4A801FC3</password>" + "</user>";
