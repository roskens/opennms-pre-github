...
public class NetworkElementFactory implements InitializingBean, NetworkElementFactoryInterface {
    ...
    public static class InterfaceComparator implements Comparator<Interface> {
        ...
        public int compare(Interface o1, Interface o2) {
            ...
            if (!"0.0.0.0".equals(o1.getIpAddress()) && !"0.0.0.0".equals(o2.getIpAddress())) {
                return new InetAddressComparator().compare(InetAddressUtils.addr(o1.getIpAddress()),
                                                           InetAddressUtils.addr(o2.getIpAddress()));
            } else {
     ...
     * (non-Javadoc)
     * @see
     * org.opennms.web.element.NetworkElementFactoryInterface#getNodeLabel(int)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.opennms.web.element.NetworkElementFactoryInterface#getIpPrimaryAddress
     * (int)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.opennms.web.element.NetworkElementFactoryInterface#getNodesLike(java
     * .lang.String)
     */
    @Override
    public List<OnmsNode> getNodesLike(String nodeLabel) {
        ...
        criteria.add(Restrictions.and(Restrictions.ilike("label", nodeLabel, MatchMode.ANYWHERE),
                                      Restrictions.or(Restrictions.isNull("type"), Restrictions.ne("type", "D"))));
        criteria.addOrder(Order.asc("label"));
     ...
     * (non-Javadoc)
     * @see
     * org.opennms.web.element.NetworkElementFactoryInterface#getNodesWithIpLike
     * (java.lang.String)
     */
    @Override
    public List<OnmsNode> getNodesWithIpLike(String iplike) {
        ...
        nodeCrit.createCriteria("ipInterfaces", "iface").add(OnmsRestrictions.ipLike(iplike)).add(Restrictions.ne("isManaged",
                                                                                                                  "D"));
     ...
     * (non-Javadoc)
     * @see
     * org.opennms.web.element.NetworkElementFactoryInterface#getNodesWithService
     * (int)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.opennms.web.element.NetworkElementFactoryInterface#getNodesWithPhysAddr
     * (java.lang.String)
     */
    @Override
    public List<OnmsNode> getNodesWithPhysAddr(String macAddr) {
        ...
        criteria.add(Restrictions.or(Restrictions.ilike("snmpIfaces.physAddr", macAddr, MatchMode.ANYWHERE),
    ...
    /*
     * (non-Javadoc)
     * @see org.opennms.web.element.NetworkElementFactoryInterface#
     * getNodesWithPhysAddrAtInterface(java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see org.opennms.web.element.NetworkElementFactoryInterface#
     * getNodesWithPhysAddrFromSnmpInterface(java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.opennms.web.element.NetworkElementFactoryInterface#getNodesWithIfAlias
     * (java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.opennms.web.element.NetworkElementFactoryInterface#getHostname(java
     * .lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.opennms.web.element.NetworkElementFactoryInterface#getInterface(int)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.opennms.web.element.NetworkElementFactoryInterface#getSnmpInterface
     * (int, int)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see org.opennms.web.element.NetworkElementFactoryInterface#
     * getInterfacesWithIpAddress(java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see org.opennms.web.element.NetworkElementFactoryInterface#
     * getInterfacesWithIfAlias(int, java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.opennms.web.element.NetworkElementFactoryInterface#getAllInterfacesOnNode
     * (int)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see org.opennms.web.element.NetworkElementFactoryInterface#
     * getAllSnmpInterfacesOnNode(int)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.opennms.web.element.NetworkElementFactoryInterface#getAllInterfaces()
     */
    @Override
    ...
    /*
     * Returns all interfaces, but only includes SNMP data if includeSNMP is
     * true
     * This may be useful for pages that don't need SNMP data and don't want to
     * execute
     ...
     * (non-Javadoc)
     * @see org.opennms.web.element.NetworkElementFactoryInterface#
     * getAllManagedIpInterfaces(boolean)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.opennms.web.element.NetworkElementFactoryInterface#getService(int,
     * java.lang.String, int)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.opennms.web.element.NetworkElementFactoryInterface#getAllServices()
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.opennms.web.element.NetworkElementFactoryInterface#getServicesOnInterface
     ...
     * (non-Javadoc)
     * @see
     * org.opennms.web.element.NetworkElementFactoryInterface#getServicesOnNode
     * (int)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.opennms.web.element.NetworkElementFactoryInterface#getServiceNameFromId
     * (int)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.opennms.web.element.NetworkElementFactoryInterface#getServiceIdFromName
     * (java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.opennms.web.element.NetworkElementFactoryInterface#getServiceIdToNameMap
     * ()
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.opennms.web.element.NetworkElementFactoryInterface#getServiceNameToIdMap
     * ()
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.opennms.web.element.NetworkElementFactoryInterface#getNodesLikeAndIpLike
    ...
    public List<OnmsNode> getNodesLikeAndIpLike(String nodeLabel, String iplike, int serviceId) {
        ...
        nodeCrit.createCriteria("ipInterfaces").add(OnmsRestrictions.ipLike(iplike)).createAlias("monitoredServices",
                                                                                                 "monSvcs").createAlias("monSvcs.serviceType",
                                                                                                                        "serviceType").add(Restrictions.eq("serviceType.id",
                                                                                                                                                           serviceId));
        nodeCrit.addOrder(Order.asc("label"));
    ...
    public List<OnmsNode> getNodesWithIpLike(String iplike, int serviceId) {
        ...
        OnmsCriteria nodeCrit = new OnmsCriteria(OnmsNode.class);
        nodeCrit.createAlias("assetRecord", "assetRecord");
        nodeCrit.createCriteria("ipInterfaces", "iface").createAlias("monitoredServices", "monSvcs").createAlias("monSvcs.serviceType",
                                                                                                                 "serviceType").add(OnmsRestrictions.ipLike(iplike)).add(Restrictions.eq("serviceType.id",
                                                                                                                                                                                         serviceId));
        nodeCrit.add(Restrictions.ne("type", "D"));
        nodeCrit.addOrder(Order.asc("label"));
        nodeCrit.setResultTransformer(Criteria.DISTINCT_ROOT_ENTITY);
     ...
     * (non-Javadoc)
     * @see
     * org.opennms.web.element.NetworkElementFactoryInterface#getAllNodes(int)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.opennms.web.element.NetworkElementFactoryInterface#getNodesFromPhysaddr
     * (java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.opennms.web.element.NetworkElementFactoryInterface#isParentNode(int)
     */
    @Override
    ...
    public boolean isRouteInfoNode(int nodeID) {
        ...
        // m_jdbcTemplate.queryForInt("SELECT COUNT(*) FROM IPROUTEINTERFACE WHERE NODEID = ? AND STATUS != 'D'",
        // nodeID);
        return (count > 0);
    }
     ...
     * (non-Javadoc)
     * @see
     * org.opennms.web.element.NetworkElementFactoryInterface#getDataLinksOnNode
     * (int)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see org.opennms.web.element.NetworkElementFactoryInterface#
     * getDataLinksOnInterface(int, int)
     */
    @Override
    ...
    public Vlan[] getVlansOnNode(int nodeID) {
        // String sqlQuery =
        // "SELECT * from vlan WHERE status != 'D' AND nodeid = ? order by vlanid;";
    ...
    public StpInterface[] getStpInterface(int nodeID) {
        ...
        /*
         * String sqlQuery =
         * "SELECT DISTINCT(stpnode.nodeid) AS droot, stpinterfacedb.* FROM "
         * +
         ...
         * ;
         * List<StpInterface> nodes = m_jdbcTemplate.query(sqlQuery, new
         * StpInterfaceRowMapper(), nodeID);
         */
    ...
    public StpInterface[] getStpInterface(int nodeID, int ifindex) {
         ...
         * ;
         * List<StpInterface> nodes = m_jdbcTemplate.query(sqlQuery, new
         * StpInterfaceRowMapper(), nodeID, ifindex);
         */
    ...
    public StpNode[] getStpNode(int nodeID) {
         ...
         * ;
         * List<StpNode> nodes = m_jdbcTemplate.query(sqlQuery, new
         * StpNodeRowMapper(), nodeID);
         */
     ...
     * (non-Javadoc)
     * @see
     * org.opennms.web.element.NetworkElementFactoryInterface#getNodeIdsWithIpLike
     * (java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.opennms.web.element.NetworkElementFactoryInterface#getNodesWithCategories
     * (org.springframework.transaction.support.TransactionTemplate,
     * java.lang.String[], boolean)
     */
    @Override
    public List<OnmsNode> getNodesWithCategories(TransactionTemplate transTemplate, final String[] categories1,
    ...
    @Override
    public List<OnmsNode> getNodesWithCategories(TransactionTemplate transTemplate, final String[] categories1,
            final String[] categories2, final boolean onlyNodesWithDownAggregateStatus) {
        return transTemplate.execute(new TransactionCallback<List<OnmsNode>>() {
     ...
     */
    @Override
    public List<OnmsNode> getNodesWithCategories(String[] categories1, String[] categories2,
