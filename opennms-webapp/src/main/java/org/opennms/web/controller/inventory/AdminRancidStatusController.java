...
/**
 * <p>
 * AdminRancidStatusController class.
 * </p>
 *
 * @author ranger
 * @version $Id: $
...
public class AdminRancidStatusController extends SimpleFormController {
    ...
    protected ModelAndView onSubmit(HttpServletRequest request, HttpServletResponse response, Object command,
        ...
        LOG.debug("AdminRancidStatusController ModelAndView onSubmit setting state to device[{}] group[{}] status[{}]",
        ...
        if (request.isUserInRole(Authentication.ROLE_ADMIN)) {
            ...
            if (!done) {
                LOG.debug("AdminRancidStatusController ModelAndView onSubmit error while updating status for{}/{}",
