...
/**
 * <p>
 * DistributedStatusSummaryController class.
 * </p>
 *
 * @author ranger
 * @version $Id: $
...
public class DistributedStatusSummaryController extends AbstractController {
    ...
    protected final ModelAndView handleRequestInternal(final HttpServletRequest request,
        ...
        // Calculate a date that equals midnight of the current day (00:00:00
        // AM)
        ...
        if (m_distributedStatusService.getApplicationCount() <= 0) {
            return new ModelAndView(
                                    ...
                                    "error",
                                    createError("No Applications Defined",
                                                "No applications have been defined for this system so a summary of application status is impossible to display."));
        }
