...
public class DaoWebOutageRepository implements WebOutageRepository, InitializingBean {
    ...
    private Outage mapOnmsOutageToOutage(OnmsOutage onmsOutage) {
        if (onmsOutage != null) {
            ...
            outage.lostServiceEventId = onmsOutage.getServiceLostEvent() != null ? onmsOutage.getServiceLostEvent().getId()
                : 0;
            ...
            outage.regainedServiceEventId = onmsOutage.getServiceRegainedEvent() != null ? onmsOutage.getServiceRegainedEvent().getId()
                : 0;
    ...
    private OutageSummary mapOnmsOutageToOutageSummary(final OnmsOutage onmsOutage) {
        return new OutageSummary(onmsOutage.getNodeId(),
                                 ...
                                 onmsOutage.getIfLostService(), onmsOutage.getIfRegainedService(), new Date());
    }

    /*
     * (non-Javadoc)
     * @see
     * org.opennms.web.outage.WebOutageRepository#countMatchingOutageSummaries
     ...
     * (non-Javadoc)
     * @see
     * org.opennms.web.outage.WebOutageRepository#countMatchingOutages(org.opennms
     * .web.outage.filter.OutageCriteria)
     */
    /** {@inheritDoc} */
    @Transactional
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.opennms.web.outage.WebOutageRepository#getMatchingOutageSummaries
     * (org.opennms.web.outage.filter.OutageCriteria)
     */
    /** {@inheritDoc} */
    @Transactional
     ...
     * (non-Javadoc)
     * @see
     * org.opennms.web.outage.WebOutageRepository#getMatchingOutages(org.opennms
     * .web.outage.filter.OutageCriteria)
     */
    /** {@inheritDoc} */
    @Transactional
