...
public class SnmpConfigServlet extends HttpServlet {
 ...
 Save("add");
    ...
    /**
     * Sends the given event via the EventProxy to the system. If null no event
     * is send.
     *
     * @param eventToSend
     *            The Event to send. If null, no event is send.
     * @return <code>true</code> if the event was send successfully and no
     *         exception occured, <code>false</code> if eventToSend is null.
     * @throws ServletException
     *             On error.
     */
