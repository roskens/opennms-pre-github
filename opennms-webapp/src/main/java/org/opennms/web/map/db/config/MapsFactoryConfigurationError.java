 ...
 * This error will typically be thrown when the class of a maps factory
 * specified in
...
public class MapsFactoryConfigurationError extends Error {
    ...
    /**
     * Create a new MapsFactoryConfigurationError with the String specified as
     * an error message.
     *
     * @param msg
    ...
    /**
     * Create a new MapsFactoryConfigurationError with the given Exception base
    ...
    /**
     * Create a new MapsFactoryConfigurationError with a given Exception base
     * cause of the error.
     *
     * @param e
     *            The exception to be encapsulated in a
