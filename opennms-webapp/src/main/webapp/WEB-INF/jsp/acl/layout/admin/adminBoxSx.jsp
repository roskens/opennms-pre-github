    ...
    <div class="box">
        <ul class="menu">
            ...
            <li><a href="user.list.page" title="<spring:message code="user.list"/>"><spring:message code="ui.list"/></a></li>
           	<li><spring:message code="admin.password.edit"/></li>
            <li><a href="admin.edit.page" title="<spring:message code="ui.action.password.edit"/>"><spring:message code="ui.action.password.edit"/></a></li>
        	</security:authorize>
        </ul></li>
        </ul>
    </div>
