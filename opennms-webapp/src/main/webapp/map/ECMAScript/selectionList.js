...
1.4.1 (2007-04-16)
corrected a bug where the closing of the selectionList failed if the id had a "_" underscore in its id, due to split error
...
selectionList.prototype.selectAndClose = function(evt) {
	...
	this.activeSelection = parseInt(result[result.length-1]);
	this.curLowerIndex = this.activeSelection;
	this.foldList();
	this.listOpen = false;
