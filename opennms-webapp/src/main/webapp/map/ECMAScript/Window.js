...
1.2.1 (2007-03-26)
made constructor namespace aware by supporting svg:svg and svg:g as parent elements, fixed bug in .remove() method
...
Window.prototype.remove = function(fireFunction) {
	if (!this.removed) {
		this.parentGroup.removeChild(this.windowGroup);
		this.removed = true;
		if (fireFunction) {
