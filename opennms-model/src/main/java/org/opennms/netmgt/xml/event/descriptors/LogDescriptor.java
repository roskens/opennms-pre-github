...
public class LogDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public LogDescriptor() {
        ...
        // -- _header
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.opennms.netmgt.xml.event.Header.class,
                                                                     "_header", "header",
        ...
        // -- _events
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.opennms.netmgt.xml.event.Events.class,
                                                                     "_events", "events",
                                                                     org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
