...
public class EventConstants {
    ...
    /**
     * The node updated event UEI (added for the ProvisioningAdapter
     * integration).
     */
    ...
    /**
     * An event used by queued to indicate that data for certain rrds should be
    ...
    /**
     * The scheduled-outages configuration was changed by the user via the web
     * UI (or manually, for that matter).
     */
    ...
    /**
     * The event config was changed by the user via the web UI, or manually, and
     * should be reloaded.
     */
    public static final String EVENTSCONFIG_CHANGED_EVENT_UEI = "uei.opennms.org/internal/eventsConfigChange";

    /**
     * The Snmp Poller config was changed by the user via the web UI, or
     * manually, and should be reloaded.
     */
    ...
    /**
     * Constant
     * <code>RELOAD_DAEMON_CONFIG_FAILED_UEI="uei.opennms.org/internal/reloadDaemonCo"{trunked}</code>
     */
    public static final String RELOAD_DAEMON_CONFIG_FAILED_UEI = "uei.opennms.org/internal/reloadDaemonConfigFailed";

    /**
     * Constant
     * <code>RELOAD_DAEMON_CONFIG_SUCCESSFUL_UEI="uei.opennms.org/internal/reloadDaemonCo"{trunked}</code>
     */
    ...
    /** The Constant PARM_IMPORT_RESCAN_EXISTING. */
    ...
    /**
     * Constant
     * <code>DATA_LINK_FAILED_EVENT_UEI="uei.opennms.org/internal/linkd/dataLink"{trunked}</code>
     */
    public static final String DATA_LINK_FAILED_EVENT_UEI = "uei.opennms.org/internal/linkd/dataLinkFailed";

    /**
     * Constant
     * <code>DATA_LINK_RESTORED_EVENT_UEI="uei.opennms.org/internal/linkd/dataLink"{trunked}</code>
     */
    public static final String DATA_LINK_RESTORED_EVENT_UEI = "uei.opennms.org/internal/linkd/dataLinkRestored";

    /**
     * Constant
     * <code>DATA_LINK_UNMANAGED_EVENT_UEI="uei.opennms.org/internal/linkd/dataLink"{trunked}</code>
     */
     ...
     * the suppression of a notification.
     */
    ...
    /**
     * The old ifIndex value sent as a parm of the 'interfaceIndexChanged'
     * event.
     */
    public static final String PARM_OLD_IFINDEX = "oldIfIndex";

    /**
     * The new ifIndex value sent as a parm of the 'interfaceIndexChanged'
     * event.
     */
    ...
    /**
     * The parameter name for the "SNMP security name string" when sent as an
     * event parameter.
     */
    public static final String PARM_SNMP_SECURITY_NAME = "securityName";

    /**
     * The parameter name for the "SNMP security level string" when sent as an
     * event parameter.
     */
    public static final String PARM_SNMP_SECURITY_LEVEL = "securityLevel";

    /**
     * The parameter name for the "SNMP auth passphrase string" when sent as an
     * event parameter.
     */
    public static final String PARM_SNMP_AUTH_PASSPHRASE = "authPassphrase";

    /**
     * The parameter name for the "SNMP auth protocol string" when sent as an
     * event parameter.
     */
    public static final String PARM_SNMP_AUTH_PROTOCOL = "authProtocol";

    /**
     * The parameter name for the "SNMP engine id string" when sent as an event
     * parameter.
     */
    public static final String PARM_SNMP_ENGINE_ID = "engineId";

    /**
     * The parameter name for the "SNMP context engine id string" when sent as
     * an event parameter.
     */
    public static final String PARM_SNMP_CONTEXT_ENGINE_ID = "contextEngineId";

    /**
     * The parameter name for the "SNMP enterprise id string" when sent as an
     * event parameter.
     */
    public static final String PARM_SNMP_ENTERPRISE_ID = "enterpriseId";

    /**
     * The parameter name for the "SNMP context name string" when sent as an
     * event parameter.
     */
    public static final String PARM_SNMP_CONTEXT_NAME = "contextName";

    /**
     * The parameter name for the "SNMP privacy passphrase string" when sent as
     * an event parameter.
     */
    public static final String PARM_SNMP_PRIVACY_PASSPHRASE = "privPassphrase";

    /**
     * The parameter name for the "SNMP privacy protocol string" when sent as an
     * event parameter.
     */
    public static final String PARM_SNMP_PRIVACY_PROTOCOL = "privProtocol";

    /**
     * The parameter name for the "SNMP max repetitions string" when sent as an
     * event parameter.
     */
    public static final String PARM_SNMP_MAX_REPETITIONS = "maxRepetitions";

    /**
     * The parameter name for the "SNMP max request size string" when sent as an
     * event parameter.
     */
    public static final String PARM_SNMP_MAX_REQUEST_SIZE = "maxRequestSize";

    /**
     * The parameter name for the "SNMP max vars per pdu string" when sent as an
     * event parameter.
     */
    public static final String PARM_SNMP_MAX_VARS_PER_PDU = "maxVarsPerPdu";

    /**
     * The parameter name for the "SNMP proxy host string" when sent as an event
     * parameter.
     */
    ...
    public static final ThreadLocal<DateFormat> FORMATTER_FULL = new ThreadLocal<DateFormat>() {
        ...
        protected synchronized DateFormat initialValue() {
            ...
            // The DateFormat.FULL format for France/Germany do not include the
            // seconds digit
            // which is necessary to have sub-minute resolution in event times.
            // For these
    ...
    /** The Constant FORMATTER_FULL_GMT. */
    ...
    /** The Constant FORMATTER_LONG_GMT. */
    ...
    /** The Constant FORMATTER_DEFAULT. */
