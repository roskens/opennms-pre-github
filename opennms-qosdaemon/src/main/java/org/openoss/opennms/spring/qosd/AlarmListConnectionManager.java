...
public interface AlarmListConnectionManager {
    ...
    /**
     * this method resets the alarm list in the AlarmMonitorBean and causes an
     * alarmlist
     * rebuilt event to be sent.
     *
     * @param _rebuilt_message
     *            message to include in the NotifyAlarmListRebuiltEvent
     */
     ...
     *            file
     * @param env
     *            the returned properties for setting up the connections to the
     *            AlarmMonitorBean
     */
