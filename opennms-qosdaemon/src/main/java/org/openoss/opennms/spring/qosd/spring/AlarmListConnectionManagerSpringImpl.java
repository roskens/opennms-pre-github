...
public class AlarmListConnectionManagerSpringImpl implements AlarmListConnectionManager {
    ...
    /**
     * <p>
     * Setter for the field <code>alarmMonitorDao</code>.
     * </p>
     *
     * @param alarmMonitorDao
     *            the alarmMonitorDao to set
     */
    ...
    /**
     * The AlarmListConnectionManagerSpringImpl instantiates the
     * AlarmMonitorBean within OpenNMS without Jboss
     * This is an alternative to contacting the bean in jboss. This only deals
     * with XML alarms
     */
     ...
     * (non-Javadoc)
     * @see
     * org.openoss.opennms.spring.qosd.AlarmListConnectionManager#getStatus()
     */
    /**
     * <p>
     ...
     * (non-Javadoc)
     * @see
     * org.openoss.opennms.spring.qosd.AlarmListConnectionManager#init(org.openoss
     * .opennms.spring.qosd.PropertiesLoader, java.util.Properties)
     */
    /** {@inheritDoc} */
    @Override
    public void init(PropertiesLoader props, Properties env) {
        try {
            LOG.debug("AlarmListConnectionManagerSpringImpl.init() initialising AlarmMonitorDao. Setting alarmMonitorDao.setLogName to:{}",
                      LOG.getName());
     ...
     * (non-Javadoc)
     * @see
     * org.openoss.opennms.spring.qosd.AlarmListConnectionManager#reset_list
     * (java.lang.String)
     */
    /** {@inheritDoc} */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.openoss.opennms.spring.qosd.AlarmListConnectionManager#send(java.
     * util.Hashtable)
     */
    /** {@inheritDoc} */
    @Override
