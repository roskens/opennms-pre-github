...
public class QoSDrx extends AbstractServiceDaemon implements QoSDrxMBean {
    ...
    protected void onStart() {
        ...
        // LOG.debug("SPRING: thread.classLoader={}",
        ...
        // LOG.debug("SPRING: context.classLoader={}",
        ...
        m_context = new ClassPathXmlApplicationContext(
                                                       new String[] { "/org/openoss/opennms/spring/qosdrx/qosdrx-spring-context.xml" },
                                                       daoContext);
        ...
        // LOG.debug("QoSDrx using /org/openoss/opennms/spring/qosdrx/qosdrx-spring-context.xml");
        // m_context = new ClassPathXmlApplicationContext(new String[] {
        // "/org/openoss/opennms/spring/qosdrx/qosdrx-spring-context.xml" });
        // LOG.debug("SPRING: context.classLoader={}",
        // m_context.getClassLoader());
        //
        // getQoSDrx().init();
