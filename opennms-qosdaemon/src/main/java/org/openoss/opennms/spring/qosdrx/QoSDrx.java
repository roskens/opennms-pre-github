...
public class QoSDrx extends AbstractServiceDaemon {
    ...
    /**
     * The first ossBeanRunner to start up in this Fiber which subsiquently
     * starts up any other OssBeans.
    ...
    /**
     * <p>
     * Setter for the field <code>initialOssBeanRunner</code>.
     * </p>
     *
     * @param initialOssBeanRunner
     *            the ossBeanRunner to set
     */
     ...
     * NOTE QoSDrx.pause() NOT IMPLEMENTED - this method does nothing and
     * returns
     */
    @Override
     ...
     * a paused state.
     * NOTE QoSDrx.resume() NOT IMPLEMENTED - this method does nothing and
     * returns
     */
    @Override
