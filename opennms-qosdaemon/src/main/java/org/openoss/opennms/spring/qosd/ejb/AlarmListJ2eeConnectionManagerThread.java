...
/**
 * The AlarmListJ2eeConnectionManagerThread tries to register with the
 * AlarmMonitorBean and maintains the connection
...
public class AlarmListJ2eeConnectionManagerThread extends Thread implements AlarmListConnectionManager {
     ...
     * (non-Javadoc)
     * @see
     * org.openoss.opennms.spring.qosd.ejb.ConnectionManager#reset_list(java
     * .lang.String)
     */
    /** {@inheritDoc} */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.openoss.opennms.spring.qosd.ejb.ConnectionManager#send(java.util.
     * Hashtable)
     */
    /** {@inheritDoc} */
    @Override
        ...
        while (true) {
            ...
            if (status == DISCONNECTED) {
                ...
                try {
                    ...
                    status = DISCONNECTED;
                    LOG.error("AlarmListJ2eeConnectionManagerThread.run() NamingException caught, Could not connect to bean",
                              name_ex);
                } catch (RemoteException remote_ex) {
                    LOG.error("AlarmListJ2eeConnectionManagerThread.run() RemoteException caught, cannot connect to bean",
                              remote_ex);
                    status = DISCONNECTED;
     ...
     * (non-Javadoc)
     * @see
     * org.openoss.opennms.spring.qosd.ejb.ConnectionManager#init(org.openoss
    ...
    private void lookupBean() throws NamingException, RemoteException {
        ...
        try {
            ...
            home = (JVTAlarmMonitorHome) PortableRemoteObject.narrow(ref, JVTAlarmMonitorHome.class);
